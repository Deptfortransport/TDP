<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test_TravelNewsFilterDateTime1.aspx.cs" Inherits="TestJSAPIMappingArc93.Test_TravelNewsFilterDateTime1" %>
              ...
              <script type="text/javascript">
                var testFunction = function() {
                  var map = new ESRIUK.Dijits.Map({
                    'class': 'tundra',
                    param_LocationX: 520000,
                    param_LocationY: 180000,
                    param_Scale: 250000,
                    param_Width: 776,
                    param_Height: 540,
                    ...
                    dojo.byId('esriukTDPMap')
                  );
                  map.startup();
                }
              </script>
              <button type="button" onclick="javascript:testFunction();return false;">Generate Map</button>
            </div>         
            <div dojoType="dijit.layout.ContentPane" style="border: 1px solid #ccc; margin: 2px; padding: 2px">
