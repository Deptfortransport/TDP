<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test_InitialExtent.aspx.cs" Inherits="TestJSAPIMappingArc93.Test_InitialExtent" %>
    ...
    <div dojoType="dijit.layout.BorderContainer" style="height: 750px; width: 1172px; margin: auto; border: 1px solid #ccc; padding: 4px;">
        ...
        <div dojoType="dijit.layout.ContentPane" region="center" style="width: 780px; overflow: hidden; font-size: 12px;">
          ...
          <div id="esriukTDPMap" class="tundra" dojoType="ESRIUK.Dijits.Map"
              param_Tools="zoom,pan" param_XMin="500000" param_YMin="190000" param_XMax="510000" param_YMax="200000"
        ...
        <div dojoType="dijit.layout.ContentPane" region="trailing" style="width: 350px; font-size: 12px;" id="testHarnessCode">             
            <div dojoType="dijit.layout.ContentPane" style="border: 1px solid #ccc; margin: 2px; padding: 2px">
                ...
                <input id="setMinXBox" type="text" style="width: 60px;" value="500000" dojoType="dijit.form.TextBox"/>
                <label for="setMinYBox">Miny: </label>
                <input id="setMinYBox" type="text" style="width: 60px;" value="190000" dojoType="dijit.form.TextBox"/>
                <br />
                <label for="setMaxXBox">Maxx: </label>
                <input id="setMaxXBox" type="text" style="width: 60px;" value="510000" dojoType="dijit.form.TextBox"/>
                <label for="setMaxYBox">Maxy: </label>
                <input id="setMaxYBox" type="text" style="width: 60px;" value="200000" dojoType="dijit.form.TextBox"/>
            ...
            Initial extent shown:<br />
            <code style="color:Blue;font-family:Courier New">
            param_XMin="500000" param_YMin="190000" param_XMax="510000" param_YMax="200000"
            </code>               
        </div>
    </div>
		<%-- START: Map control required tags --%>
