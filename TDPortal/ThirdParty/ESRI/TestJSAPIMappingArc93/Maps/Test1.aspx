<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test1.aspx.cs" Inherits="TestJSAPIMappingArc93._Default" %>
    ...
    <div dojoType="dijit.layout.BorderContainer" style="height: 750px; width: 1172px; margin: auto; border: 1px solid #ccc; padding: 4px;">
        ...
        <div dojoType="dijit.layout.ContentPane" region="center" style="width: 780px; overflow: hidden; font-size: 12px;">
          ...
          <div id="esriukTDPMap" class="tundra" dojoType="ESRIUK.Dijits.Map"
              param_TravelNews="transportType:all,incidentType:all,severity:all,timePeriod:current,datetime:10/07/1981 10/43/22"
              param_Symbols="[{x:450000,y:200000,label:'hello world',type:'start'},{x:451000,y:195000,label:'hello world 2',type:'via'},{x:451000,y:175000,label:'MY SYMBOL',type:'symbol',symbolKey:'TRIANGLE'},{x:443000,y:187000,label:'hello world 3',type:'end',main:true}]"
              param_Tools="selectNearby,userDefined"
        ...
        <div dojoType="dijit.layout.ContentPane" region="trailing" style="width: 350px; font-size: 12px;" id="testHarnessCode">
            ...
            <div dojoType="dijit.layout.ContentPane" style="border: 1px solid #ccc; margin: 2px; padding: 2px">
                ...
                <input id="setMarkerSymbolType" type="text" style="width: 75px;" value="TRIANGLE"
                    dojoType="dijit.form.TextBox" />  
                <span dojoType="dijit.Tooltip" connectId="setMarkerSymbolType" toggle="explode">Symbol Types = CIRCLE | SQUARE | TRIANGLE | DIAMOND | INVALID</span>                      
                <br />
		...
		<%-- START: Map control required tags --%>
    <script type="text/javascript" src="../esriMap/ESRIJSAPIv1.4/default.ashx?language=en"></script>
		<%-- END: Map control required tags --%>        
