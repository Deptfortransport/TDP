...
return {
  ...
  graphics:{
    ...
    //  description:
    //    This is the image used when calling map.addIconAndInfoWindow
    pointMisc:((function(){ return new esri.symbol.PictureMarkerSymbol(djConfig.appPath+'/images/location.'+(dojo.isIE<7?'gif':'png'), 16, 16);})()),
