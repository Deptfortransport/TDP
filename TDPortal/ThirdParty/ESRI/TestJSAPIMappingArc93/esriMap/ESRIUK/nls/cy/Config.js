({
  travelNewsEnum:{
    pRoad:'Gwaith ffordd',
    pRail:'Gwaith Peirianyddol ar y Rheilffyrdd',
    upRoad:'Digwyddiadu ar y ffyrdd',
    upRail:'Digwyddiadau cludiant cyhoeddus' 
  },
  
  planAJourneyText:{
    addPointPrefix:'Cynlluniwch siwrnai',
  ...
  mapNavPanel:{
    ...
    panNorth:'Trem ar y Gogledd',
    panEast:'Trem ar y Dwyrain',
    panSouth:'Trem ar y De',
    panWest:'Trem ar y Gorllewin',
