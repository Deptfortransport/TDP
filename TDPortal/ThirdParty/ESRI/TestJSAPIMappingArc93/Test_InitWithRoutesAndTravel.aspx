<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test_InitWithRoutesAndTravel.aspx.cs" Inherits="TestJSAPIMappingArc93.Test_InitWithRoutesAndTravel" %>
    ...
    <div dojoType="dijit.layout.BorderContainer" style="height: 750px; width: 1172px; margin: auto; border: 1px solid #ccc; padding: 4px;">
        ...
        <div dojoType="dijit.layout.ContentPane" region="center" style="width: 780px; overflow: hidden; font-size: 12px;">
          ...
          <div id="esriukTDPMap" class="tundra" dojoType="ESRIUK.Dijits.Map"
              ...
              param_Routes="[{sessionId:'1',routeNumber:1,type:'PT'},{sessionId:'1',routeNumber:1,type:'Road'},{sessionId:'1',routeNumber:3,type:'Road'},{sessionId:'1',routeNumber:1,type:'Cycle'}]"
