<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test_InfoWindowX.aspx.cs" Inherits="TestJSAPIMappingArc93.Test_InfoWindowX" %>
...
<body>
    ...
    <div>
      Added <code style="color:Blue">&lt;style type="text/css"&gt;.hide{display:none}&lt;/style&gt;</code> to main document CSS
    </div>
