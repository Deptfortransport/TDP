...
function setupPaging() {
    //$('div.travelNewsWidget div.tnHeadlinesContainer ul.PagerContainer li.pageItem').css('display', 'none');

    var paging_div = $('div.travelNewsWidget div.tnHeadlinesContainer');
