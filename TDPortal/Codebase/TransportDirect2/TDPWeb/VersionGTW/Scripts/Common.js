function downloadJSAtOnload(d, src, id, defer) {
    if (!d) { d = document; }
    if (d.getElementById(id)) { return; }
    var js = d.createElement("script");
    js.src = src; js.id = id;
    js.async = true;
    if (defer) { js.setAttribute('defer', 'true'); } 
...
$(document).ready(function () {
    ...
    setUpSJPSnippetNavigation('#top-tips div.snippet-header');
