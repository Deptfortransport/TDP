...
// DESCRIPTION  	: DataGateway import task to import GNAT admin areas
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to import GNAT admin areas
    /// </summary>
    public class TDPGNATAdminAreasDataImporter : DatasourceImportTask
    {
        #region Private Fields

        private string importPropertyName = string.Empty;
        private const string propertyKey = "datagateway.sqlimport.TDPGNATAdminAreasData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.TDPGNATAdminAreasData.feedname";
        
        private const string logDescription = "GNAT AdminAreas Import";
        ...
        public TDPGNATAdminAreasDataImporter
        ...
        private bool Convert()
        {
            ...
            try
            {
                ...
                using (XmlCsvReader CsvXmlConverter = new TransportDirect.Common.DatabaseInfrastructure.XmlCsvReader(myImportFileName, xmlDoc.NameTable))
                {
                    ...
                    CsvXmlConverter.RootName = "GNATAdminAreasData";
                    CsvXmlConverter.RowName = "GNATAdminArea";
