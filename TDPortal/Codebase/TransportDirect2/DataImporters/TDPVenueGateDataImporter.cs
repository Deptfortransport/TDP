// *********************************************** 
// NAME             : TDPVenueGateDataImporter.cs      
// AUTHOR           : Mark Turner
// DATE CREATED     : 10 May 2011
// DESCRIPTION  	: DataGateway import task to import venue gate data
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to import venue gate data
    /// </summary>
    public class TDPVenueGateDataImporter : DatasourceImportTask
    {
        #region Private Fields
        private const string propertyKey = "datagateway.sqlimport.TDPVenueGateData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.TDPVenueGateData.feedname";
        private string importPropertyName = string.Empty;
        private const string logDescription = "Venue Gate Data Import";
        ...
        public TDPVenueGateDataImporter
