// *********************************************** 
// NAME             : TDPGNATLocationsDataImporter.cs      
// AUTHOR           : Mark Turner
// DATE CREATED     : 18 May 2011
// DESCRIPTION  	: DataGateway import task to import GNAT locations
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to GNAT locations data
    /// </summary>
    public class TDPGNATLocationsDataImporter : DatasourceImportTask
    {
        #region Private Fields
        private const string propertyKey = "datagateway.sqlimport.TDPGNATLocationsData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.TDPGNATLocationsData.feedname";
        private string importPropertyName = string.Empty;
        private const string logDescription = "GNAT Locations Import";
        ...
        public TDPGNATLocationsDataImporter
        ...
        private bool Convert()
        {
            ...
            try
            {
                ...
                using (XmlCsvReader CsvXmlConverter = new XmlCsvReader(myImportFileName, xmlDoc.NameTable))
                {
                    ...
                    CsvXmlConverter.RootName = "GNATLocationsData";
                    CsvXmlConverter.RowName = "GNATLocation";
                    ...
                    AddAttributeToXmlDoc(xmlDoc, xmlNameSpace, (string)Properties.Current["datagateway.sqlimport.TDPGNATLocationsData.xmlnamespace"]);

                    // Now appending namespace:xsi attribute 		
                    AddAttributeToXmlDoc(xmlDoc, xmlNamespaceXs, (string)Properties.Current["datagateway.sqlimport.TDPGNATLocationsData.xmlnamespacexsi"]);
