// *********************************************** 
// NAME             : TDPVenueAdditionalDataImporter.cs      
// AUTHOR           : Amit Patel
// DATE CREATED     : 28 Apr 2011
// DESCRIPTION  	: DataGateway import task to import venue additional data
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to import venue additional data
    /// </summary>
    public class TDPVenueAdditionalDataImporter: DatasourceImportTask
    {
        #region Private Fields
        private const string propertyKey = "datagateway.sqlimport.TDPAdditionalVenueData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.TDPAdditionalVenueData.feedname";
		private string importPropertyName = string.Empty;				
		private const string logDescription = "Additional Venue Data Import" ;
        ...
        public TDPVenueAdditionalDataImporter
