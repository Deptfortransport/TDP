// *********************************************** 
// NAME             : TDPParkAndRideLocationsImporter.cs      
// AUTHOR           : Amit Patel
// DATE CREATED     : 21 Apr 2011
// DESCRIPTION  	: DataGateway import task to import park and ride locations
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to import park and ride locations
    /// </summary>
    public class TDPParkAndRideLocationsImporter : DatasourceImportTask
    {
         #region Private Fields
        private const string propertyKey = "datagateway.sqlimport.TDPParkAndRideLocations.Name";
        private const string propertyFeedName = "datagateway.sqlimport.TDPParkAndRideLocations.feedname";
		private string importPropertyName = string.Empty;				
		private const string logDescription = "Park And Ride Locations Import" ;
        ...
        public TDPParkAndRideLocationsImporter
