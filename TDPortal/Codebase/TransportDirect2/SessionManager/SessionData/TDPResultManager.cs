// *********************************************** 
// NAME             : TDPResultManager.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 24 Mar 2011
// DESCRIPTION  	: TDPResultManager class to hold multiple journey results for a session.
...
{
    /// <summary>
    /// TDPResultManager class to hold multiple journey results for a session
    /// </summary>
    [Serializable()]
    public class TDPResultManager : ITDPSessionAware
    {
