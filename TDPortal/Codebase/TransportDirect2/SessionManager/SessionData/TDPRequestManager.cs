// *********************************************** 
// NAME             : TDPRequestManager.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 10 Feb 2011
// DESCRIPTION  	: TDPRequestManager class to hold multiple journey requests for a session.
// The class uses the hash property of the request as the key to ensure "identical" requests do not fill
// the historical requests made. This allows the TDPResultManager to serve the already planned
...
{
    /// <summary>
    /// TDPRequestManager class to hold multiple journey requests for a session
    /// </summary>
    [Serializable()]
    public class TDPRequestManager : ITDPSessionAware
    {
