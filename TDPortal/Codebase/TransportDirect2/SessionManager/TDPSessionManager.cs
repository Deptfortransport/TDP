// *********************************************** 
// NAME             : TDPSessionManager.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 10 Mar 2011
// DESCRIPTION  	: TDPSessionManager. The session manager allows web pages
// to store data in a type safe manner, by use of unique Keys.  
// This can then be retrieved at a later time by use of the same Key. 
// ************************************************
// 
...
{
    /// <summary>
    /// TDPSessionManager class
    /// </summary>
    public class TDPSessionManager : ITDPSessionManager, IDisposable
    {
        ...
        /// </summary>
        private TDPSession tdpSession = new TDPSession();
        ...
        /// <summary>
        /// Constructor for the TDPSessionManager that is used through the ServiceDiscovery
        /// </summary>
        /// <param name="sessFactory">The session factory to be used</param>
        public TDPSessionManager(ITDPSessionFactory sessFactory)
        {
