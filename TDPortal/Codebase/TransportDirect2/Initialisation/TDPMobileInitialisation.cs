// *********************************************** 
// NAME             : TDPMobileInitialisation.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 06 Feb 2012
// DESCRIPTION  	: TDPMobileInitialisation class for initialising services needed for the TDPMobile project
// ************************************************
// 
...
using TDP.UserPortal.DepartureBoardService;
...
{
    /// <summary>
    /// Mobile Initialisation class
    /// </summary>
    public class TDPMobileInitialisation : IServiceInitialisation
    {
        ...
        public void Populate(Dictionary<string, IServiceFactory> serviceCache)
        {
            ...
            Logger.Write(new OperationalEvent(TDPEventCategory.Infrastructure, TDPTraceLevel.Info, "INITIALISATION Started TDPMobileInitialisation"));
            ...
            // PageTimeoutData
            Logger.Write(new OperationalEvent(TDPEventCategory.Infrastructure, TDPTraceLevel.Verbose, "INITIALISATION Adding to service cache: PageTimeoutData"));
            serviceCache.Add(ServiceDiscoveryKey.PageTimeoutData, new PageTimeoutFactory());
            ...
            // AdditionalData
            Logger.Write(new OperationalEvent(TDPEventCategory.Infrastructure, TDPTraceLevel.Verbose, "INITIALISATION Adding to service cache: AdditionalData"));
            serviceCache.Add(ServiceDiscoveryKey.AdditionalData, new AdditionalDataFactory());

            // AirDataProvider
            Logger.Write(new OperationalEvent(TDPEventCategory.Infrastructure, TDPTraceLevel.Verbose, "INITIALISATION Adding to service cache: AirDataProvider"));
            ...
            Logger.Write(new OperationalEvent(TDPEventCategory.Infrastructure, TDPTraceLevel.Verbose, "INITIALISATION Adding to service cache: DepartureBoardService"));
            serviceCache.Add(ServiceDiscoveryKey.DepartureBoardService, new DepartureBoardServiceFactory());

            Logger.Write(new OperationalEvent(TDPEventCategory.Infrastructure, TDPTraceLevel.Info, "INITIALISATION Completed TDPMobileInitialisation"));
        }
