...
namespace TDP.UserPortal.JourneyPlanRunner
{
    ...
    public class JourneyPlanRunnerCaller : MarshalByRefObject, IJourneyPlanRunnerCaller
    {
        ...
        private delegate void DelegateInvokeCJPManager(ITDPJourneyRequest journeyRequest, string sessionID, string lang);
        ...
        public void InvokeCJPManager(ITDPJourneyRequest journeyRequest, ITDPSession sessionInfo, string lang)
        {
        ...
        /// <param name="lang">The language of the current UI culture</param>
        private void InvokeCJP(ITDPJourneyRequest journeyRequest, string sessionID, string lang)
        {
            try
            {
        ...
        public void CallCJP(ITDPJourneyRequest journeyRequest, string sessionID, string lang)
        {
            try
            {
                // Get a CJP Manager from the service discovery
                ICJPManager cjpManager = TDPServiceDiscovery.Current.Get<ICJPManager>(ServiceDiscoveryKey.CJPManager);
                ...
                ITDPJourneyResult journeyResult = cjpManager.CallCJP(
                    journeyRequest,
                    sessionID,
                    referenceTransation,
                    lang);
