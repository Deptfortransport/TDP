// *********************************************** 
// NAME             : ScriptCompressor.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 06 Feb 2012
// DESCRIPTION  	: ScriptCompressor HttpHandler and HttpModule code has been taken from
//                  : http://madskristensen.net/post/Optimize-WebResourceaxd-and-ScriptResourceaxd.aspx
//                  : This is used to compress and combine into one file the WebResource.axd and ScriptResource.axd
//                  : files in a web request to reduce the number of requests and download amount
//                  
//                  : To include in website, the following lines should be added to web.config (for IIS7):
//<system.webServer>
//  <modules>
//      <add name="ScriptCompressorModule" type="TDP.Common.Web.ScriptCompressorModule, tdp.common.web" />
//  </modules>
//  <handlers>
//      <add name="ScriptCompressorHandler" verb="*" path="*js.axd" type="TDP.Common.Web.ScriptCompressorHandler, tdp.common.web" />
//  </handlers>
//</system.webServer>
// ************************************************
// 
...
{
    /// <summary>
    /// ScriptCompressorHandler
    /// </summary>
    public sealed class ScriptCompressorHandler : IHttpHandler
    {
    ...
    /// </summary>
    public sealed class ScriptCompressorModule : IHttpModule
    {
