...
namespace TDP.TestProject.DataImporters
{
    ...
    /// <summary>
    ///This is a test class for TDPVenueAccessDataImporterTest and is intended
    ///to contain all TDPVenueAccessDataImporterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class TDPVenueAccessDataImporterTest
    {
        ...
        /// <summary>
        ///A test for TDPVenueAccessDataImporter Constructor
        ///</summary>
        [TestMethod()]
        public void TDPVenueAccessDataImporterConstructorTest()
        {
            string venueAccessDatafeed = "VenueAccessData v1.3.xml";
            ...
            TDPVenueAccessDataImporter target = new TDPVenueAccessDataImporter(feed, params1, params2, utility, processingDirectory);
            int actual = target.Run(venueAccessDatafeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for TDPVenueAccessDataImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void TDPVenueAccessDataImporterConstructorTestWrongFileAndFeed()
        {
            string venueAccessDatafeed = "VenueAccessData v1.3.xml1";
        ...
        ///</summary>
        [TestMethod()]
        public void TDPVenueAccessDataImporterConstructorTestNoFeedfile()
        {
            string venueAccessDatafeed = null;
