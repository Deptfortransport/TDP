...
namespace TDP.TestProject.DataImporters
{
    ...
    ///</summary>
    [TestClass()]
    public class TDPTravelcardDataImporterTest
    {
        ...
        /// <summary>
        ///A test for TDPTravelcardDataImporter Constructor
        ///</summary>
        [TestMethod()]
        public void TDPTravelcardDataImporterConstructorTest()
        {
            string datafeed = "SJPTravelcardData.xml";
            ...
            TDPTravelcardDataImporter target = new TDPTravelcardDataImporter(feed, params1, params2, utility, processingDirectory);
            int actual = target.Run(datafeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for TDPTravelcardDataImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void TDPTravelcardDataImporterConstructorTestWrongFileAndFeed()
        {
            string datafeed = "SJPTravelcardData.xml1";
