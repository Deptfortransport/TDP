...
namespace TDP.TestProject.DataImporters
{
    ...
    /// <summary>
    ///This is a test class for TDPVenueGateDataImporterTest and is intended
    ///to contain all TDPVenueGateDataImporterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class TDPVenueGateDataImporterTest
    {
        ...
        /// <summary>
        ///A test for TDPVenueGateDataImporter Constructor
        ///</summary>
        [TestMethod()]
        public void TDPVenueGateDataImporterConstructorTest()
        {
            string venueGateDatafeed = "Olympic Venues 0.10.xml";
            ...
            TDPVenueGateDataImporter target = new TDPVenueGateDataImporter(feed, params1, params2, utility, processingDirectory);
            int actual = target.Run(venueGateDatafeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for TDPVenueGateDataImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void TDPVenueGateDataImporterConstructorTestWrongFileAndFeed()
        {
            string venueGateDatafeed = "Olympic Venues 0.10.xml1";
