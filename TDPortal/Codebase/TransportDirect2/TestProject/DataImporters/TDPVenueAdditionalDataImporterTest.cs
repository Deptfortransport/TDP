...
namespace TDP.TestProject.DataImporters
{
    ...
    /// <summary>
    ///This is a test class for TDPVenueAdditionalDataImporterTest and is intended
    ///to contain all TDPVenueAdditionalDataImporterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class TDPVenueAdditionalDataImporterTest
    {
        ...
        /// <summary>
        ///A test for TDPVenueAdditionalDataImporter Constructor
        ///</summary>
        [TestMethod()]
        public void TDPVenueAdditionalDataImporterConstructorTest()
        {
            string venueAdditionalDatafeed = "AdditionalVenueData v1.4.xml";
            ...
            TDPVenueAdditionalDataImporter target = new TDPVenueAdditionalDataImporter(feed, params1, params2, utility, processingDirectory);
            int actual = target.Run(venueAdditionalDatafeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for TDPVenueAdditionalDataImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void TDPVenueAdditionalDataImporterConstructorTestWrongFileAndFeed()
        {
            string venueAdditionalDatafeed = "AdditionalVenueData v1.4.xml1";
