...
namespace TDP.TestProject.SessionManager
{
    ...
    /// <summary>
    ///This is a test class for TDPRequestManagerTest and is intended
    ///to contain all TDPRequestManagerTest Unit Tests
    ///</summary>
    [TestClass()]
    public class TDPRequestManagerTest
    {
        ...
        /// <summary>
        ///A test for TDPRequestManager Constructor
        ///</summary>
        [TestMethod()]
        public void TDPRequestManagerConstructorTest()
        {
            TDPRequestManager target = new TDPRequestManager();
