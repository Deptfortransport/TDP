...
exec sp_addsubscription @publication = N'SJPGazetteerTransactionalPublication', 
@subscriber = N'$(WorkUnit)', @destination_db = N'SJPGazetteer', 
@subscription_type = N'Push', @sync_type = N'automatic', @article = N'all', 
@update_mode = N'read only', @subscriber_type = 0
exec sp_addpushsubscription_agent @publication = N'SJPGazetteerTransactionalPublication', 
@subscriber = N'$(WorkUnit)', @subscriber_db = N'SJPGazetteer', 
