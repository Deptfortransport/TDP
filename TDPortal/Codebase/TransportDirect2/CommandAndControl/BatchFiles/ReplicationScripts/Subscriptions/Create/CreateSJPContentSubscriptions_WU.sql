...
exec sp_addsubscription @publication = N'SJPContentTransactionalPublication', 
@subscriber = N'$(WorkUnit)', @destination_db = N'SJPContent', 
@subscription_type = N'Push', @sync_type = N'automatic', @article = N'all', 
@update_mode = N'read only', @subscriber_type = 0
exec sp_addpushsubscription_agent @publication = N'SJPContentTransactionalPublication', 
@subscriber = N'$(WorkUnit)', @subscriber_db = N'SJPContent', 
