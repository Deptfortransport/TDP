...
namespace TDP.UserPortal.TDPMobile
{
    ...
    /// </summary>
    public partial class CookiePage : TDPPageMobile
    {
        #region Constructor
        ...
        {
            titleMessage.InnerHtml = GetResourceMobile("Cookie.HeadingTitle.Text");
            bodyTextDiv.InnerHtml = GetResourceMobile("Cookie.ContentDiv.Html");
        }
