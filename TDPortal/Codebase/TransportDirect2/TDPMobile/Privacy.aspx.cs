...
namespace TDP.UserPortal.TDPMobile
{
    ...
    /// </summary>
    public partial class PrivacyPage : TDPPageMobile
    {
        #region Constructor
        ...
        {
            titleMessage.InnerHtml = GetResourceMobile("Privacy.HeadingTitle.Text");
            bodyTextDiv.InnerHtml = GetResourceMobile("Privacy.ContentDiv.Html");
        }
