...
// DESCRIPTION          : DataGateway import task to import Accessible operators
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/JourneyControl/AccessibleOperatorDataImporter.cs-arc  $ 
//
//   Rev 1.0   Dec 10 2012 12:13:48   mmodi
//Initial revision.
...
{
    /// <summary>
    /// DataGateway import task to import Accessible operators
    /// </summary>
    public class AccessibleOperatorDataImporter : DatasourceImportTask
    {
        #region Private Fields

        private string importPropertyName = string.Empty;
        private const string propertyKey = "datagateway.sqlimport.AccessibleOperatorData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.AccessibleOperatorData.feedname";
        
        private const string logDescription = "Accessible Operator Import";
        ...
        public AccessibleOperatorDataImporter
        ...
        private bool Convert()
        {
            ...
            try
            {
                ...
                using (XmlCsvReader CsvXmlConverter = new XmlCsvReader(myImportFileName, xmlDoc.NameTable))
                {
                    ...
                    CsvXmlConverter.RootName = "AccessibleOperatorData";
                    CsvXmlConverter.RowName = "AccessibleOperator";
