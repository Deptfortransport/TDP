// *********************************************** 
// NAME                 : JourneyNoteFilterDataImporter.cs
// AUTHOR               : Mitesh Modi
// DATE CREATED         : 19/03/2013 
// DESCRIPTION          : DataGateway import task to import JourneyNoteFilter data
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/JourneyControl/JourneyNoteFilterDataImporter.cs-arc  $ 
//
...
namespace TransportDirect.UserPortal.JourneyControl
{
    ...
    /// <summary>
    /// DataGateway import task to import JourneyNoteFilter data
    /// </summary>
    public class JourneyNoteFilterDataImporter : DatasourceImportTask
    {
        #region Private Fields

        private string importPropertyName = string.Empty;
        private const string propertyKey = "datagateway.sqlimport.JourneyNoteFilterData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.JourneyNoteFilterData.feedname";
        
        private const string logDescription = "Journey Note Filter Import";

        private const string csvxmlRootName = "JourneyNoteFilterData";
        private const string csvxmlRowName = "JourneyNoteFilter";
        ...
        public JourneyNoteFilterDataImporter
