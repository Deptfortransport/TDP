// ***********************************************
// NAME                 : TestStubGisQuery.cs
// AUTHOR               : Alistair Caunt
// DATE CREATED         : 13/10/03
// DESCRIPTION			: Implementation of the TestStubGisQuery class
// ************************************************
...
namespace  TransportDirect.UserPortal.JourneyControl
{
	...
	public class TestStubGisQuery : IGisQuery, IServiceFactory
	{
		...
		/// <summary>
		///  Method used by ServiceDiscovery to get an instance of the TestGisQuery class.
		/// </summary>
