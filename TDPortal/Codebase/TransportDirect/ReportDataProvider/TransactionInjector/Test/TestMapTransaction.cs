...
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/ReportDataProvider/TransactionInjector/TestMapTransaction.cs-arc  $
//
...
//Initial revision.
//
//   Rev 1.4   Feb 08 2005 13:16:44   RScott
//Assertion changed to Assert
//
//   Rev 1.3   Apr 23 2004 17:22:26   geaton
//IR827 - Allow timeout specification for transactions.
//
//   Rev 1.2   Mar 02 2004 09:17:38   geaton
...
namespace TransportDirect.ReportDataProvider.TransactionInjector
{
	...
	/// </summary>
	[TestFixture]
	public class TestMapTransaction
	{
		...
		public void TestSubmitTransaction()
		{
			...
			try
			{
				...
				MapTransactionGroup grp = new MapTransactionGroup();				

				ArrayList transList = new ArrayList();

                grp.CreateTransactions(testMapSrcDir, transList, webservice, new TimeSpan(0, 0, 1, 0), new TimeSpan(0, 0, 30, 0), "INJ01");			
			
				foreach( MapTransaction mt in transList)
				{
					mt.ExecuteTransaction();
				}	
