// *********************************************** 
// NAME			: GazetteerTransactionGroup.cs
// AUTHOR		: Peter Norell
// DATE CREATED	: 07/01/2004
// DESCRIPTION	: Gazetteer Transaction group
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/ReportDataProvider/TransactionInjector/GazetteerTransactionGroup.cs-arc  $
//
//   Rev 1.1   Jul 16 2010 09:39:28   PScott
...
//Initial revision.
//
//   Rev 1.3   Apr 23 2004 17:21:50   geaton
//IR827 - Allow timeout specification for transactions.
//
//   Rev 1.2   Feb 16 2004 17:25:54   geaton
...
{
	/// <summary>
	/// Summary description for GazetteerTransactionGroup.
	/// </summary>
	public class GazetteerTransactionGroup : ITDTransactionGroup
	{
		/// <summary>
                                       ...
                                       string machineName)
		{
			...
			try
			{
				...
				XmlSerializer serializer = 
					new XmlSerializer(typeof(GazetteerTransaction));
				...
				{			
					...
					GazetteerTransaction transaction = (GazetteerTransaction)serializer.Deserialize(reader);
			...
			{	
				throw new TDException(String.Format(Messages.Service_FailedCreatingGazetteer, currentFile, exception.Message), false, TDExceptionIdentifier.RDPTransactionInjectorFailedCreatingStationInfo); 
			}
