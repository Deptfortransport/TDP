// *********************************************** 
// NAME                 : DepartureBoardServiceActivityType.cs
// AUTHOR               : Sanjeev Chand
// DATE CREATED         : 14/12/2005 
// DESCRIPTION  		: Departure Board Activity Type enum 
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/EnhancedExposedServicesDataTransfer/DepartureBoard/V1/DepartureBoardServiceActivityType.cs-arc  $ 
//
...
{
	/// <summary>
	/// Enumeration for Departure Board Stop Activity Type
	/// </summary>
	[System.Serializable]
