-- *************************************************************************************
-- NAME 		: SC10013_TransportDirect_Content_13_Accessibility.sql
...
-------------------------------------------------------------
EXEC AddtblContent
1, 20, 'TitleText', '/Channels/TransportDirect/About/Accessibility',
'<div>
    <h1>
        Accessibility
    </h1>
...
EXEC AddtblContent
1, 20, 'Body Text', '/Channels/TransportDirect/About/Accessibility', 
'<div id="primcontent">
<div id="contentarea">
<div id="hdtypethree">
<h2>Accessibility</h2></div>
<p>Transport Direct is committed to providing usable and accessible information. We have an ongoing commitment to reach level AA of the WAI standards and routinely monitor Transport Direct against this standard as part of each development release.</p>
<p>&nbsp;</p>
<p>A comprehensive audit of the accessibility of the site has been carried out using both automated and manual checks as well as testing by users with varying degrees of disability.  We asked testers to perform typical tasks on the portal with the objective of finding out if they experience any difficulties. The findings from these tests were used to make design enhancements to the portal. For example:</p>
<p>&nbsp;</p>
<ul class="lister">
...
<li>Our journey itineraries can be presented in tables as well as using a graphical time line </li>
<li>When you log on as a registered user, you can extend the session timeout limit to make sure you have enough time to complete any actions within the site </li>
</ul>
<p></p>
<p></p>
<p></p>
...
<p></p>
<p>&nbsp;</p>
<p>This portal currently conforms to Level AA of the Web Accessibility Guidelines (WAI) produced by the World Wide Web Consortium (W3C) and to XHTML standards.</p>
<p>&nbsp;</p>
...
<a href="https://www.gov.uk/transport-disabled" target="_blank">Door-to-door:&nbsp; A travel guide for disabled people <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(opens in new window)" /></a><br />
<a href="http://rica.org.uk/content/accessible-public-transport-london" target="_blank">In and around London <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(opens in new window)" /></a><br />
<br /></font></u></p>
<p>*Also, if you need to take a taxi from or to any railway station, airport, bus/coach station, ferry terminal, Underground, Metro or tram station in Britain, you can check the accessibility of taxis or private hire cars serving that station.&nbsp;See: <a href="/Web2/Help/HelpTaxi.aspx#A5.1">How can I find taxi information for stations I am travelling to in my journey?; </a>&nbsp;<a href="/Web2/Help/HelpTaxi.aspx#A5.2">Can I find out if the taxis are wheelchair accessible? </a></p>
<p>&nbsp;</p>
<div></div></div></div>
<div></div>'
,
...
<li>Gellir cyflwyno ein teithlyfrau mewn tablau ynghyd &#226; llinell amser graffigol</li>
<li>When you log on as a registered user, you can extend the session timeout limit to make sure you have enough time to complete any actions within the site </li>
</ul>
<p></p>
<p></p>
...
<a href="https://www.gov.uk/transport-disabled" target="_blank" >Drws-i-ddrws: Canllaw teithio i bobl anabl <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(yn agor ffenestr newydd)" /></a><br />
<a href="http://rica.org.uk/content/accessible-public-transport-london" target="_blank" >Yn ac o amgylch Llundain <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(yn agor ffenestr newydd)" /></a><br />
<br /></font></u></p>
<p>*Hefyd os oes angen i chi gymryd tacsi o neu i unrhyw orsaf rheilffordd, maes awyr, gorsaf bysiau/bysiau moethus, terfynnell fferri, gorsaf tr&#234;n tanddaearol, metro neu dram ym Mhrydain, gallwch weld beth yw&#8217;r sefyllfa o ran hygyrchedd tacsis neu geir hurio preifat sy&#8217;n gwasanaethu&#8217;r orsaf honno. Gweler: <a href="/Web2/Help/HelpTaxi.aspx#A5.1">Sut y gallaf archebu tacsi sy&#8217;n hygyrch i gadair olwyn i neu o brif orsafoedd cludiant?</a> ; <a href="/Web2/Help/HelpTaxi.aspx#A5.2">Fedra" i ddarganfod a yw''r tacsis yn hygyrch i gadeiriau olwyn?</a> </p>
<p>&nbsp;</p></div></div>
<div></div>
<div></div>
<div></div>'
