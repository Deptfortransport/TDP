-- *************************************************************************************
-- NAME 		: SCP10705_London2012_5_FAQs.sql
-- DESCRIPTION  : FAQs (Full Set) - modified for London2012
-- AUTHOR		: xxxxxxxx
-- Date			: 20 Nov 2008
-- *************************************************************************************
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.6">2.6) How can I plan a day trip to two destinations?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.7">2.7) How do I '
, 
'<div id="primcontent">
<div id="contentarea">
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.8">2.8) If I add a connecting public transport journey to a car/taxi journey, how can I make sure I have enough time to park my car/pay the taxi fare before boarding the train?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.9">2.9) How do I change the leaving or arrival times for the start or the end of my journey?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.10">2.10) How is the Journey Planner (Powered By) different from other journey planners?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.11">2.11) How can I find out about the accessibility of the types of transport in the journey?</a></p>
<div align="right"><a name="WhoOperates"></a><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
<div align="right"><a name="WhoOperates"></a><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
<div class="hdtypethree"><a id="TDOnPDAOrMobile" name="TDOnPDAOrMobile"></a><h2>14. Using the Journey Planner services on your PDA/Mobile/Digital TV</h2></div>
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpMobile.aspx#A14.4">14.4)&nbsp;How can I access the Journey Planner on digital television?</a></p>
<div align="right"><a name="WhoOperates"></a><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
IF @ptrValText IS NOT NULL BEGIN
   ...
   UPDATETEXT [dbo].[tblContent].[Value-Cy] @ptrValText NULL 0 'href="/Web2/Help/HelpJplan.aspx#A2.6">2.6) Sut y gallaf gynllunio taith dydd i ddau gyrchfan?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.7">2.7) Sut y gallaf ychwanegu siwrnai gysylltiol at fy siwrnai gyffredinol?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.8">2.8) Pe byddwn yn ychwanegu siwrnai trafnidiaeth gyhoeddus gysylltiol at siwrnai gar/tacsi, sut y gallaf sicrhau bod gennyf ddigon o amser i barcio fy nghar/talu am y tacsi cyn mynd ar y tr&#234;n?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.9">2.9) Sut ydw i''n newid amserau gadael neu gyrraedd ar gyfer dechrau neu ddiwedd fy siwrnai?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.10">2.10) Sut mae Journey Planner yn wahanol i gynllunwyr siwrneion eraill?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.11">2.11) Sut y gallaf ddarganfod am hygyrchedd y mathau o gludiant yn y siwrnai?</a></p>
<div align="right"><a name="EnablingIntelligentTravel"></a><a class="jpt" href="#logoTop">Yn &#244;l i''r brig <img alt="Yn cl &#13;&#10;i&#8217;r brig" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpInfo.aspx#A13.11">13.11) Pam fod porwr fy nghwmni yn rhwystro rhai swyddogaethau Journey Planner?</a></p>
<div align="right"><a name="EnablingIntelligentTravel"></a><a class="jpt" href="#logoTop">Yn &#244;l i''r brig <img alt="Yn cl &#13;&#10;i&#8217;r brig" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
<div class="hdtypethree"><a id="TDOnPDAOrMobile" name="TDOnPDAOrMobile"></a><h2>14. Defnyddio gwasanaethau teithio byw Journey Planner ar PDA/ffôn symudol/Teledu Digidol</h2></div>
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpMobile.aspx#A14.4">14.4)&nbsp;Sut allaf i gael mynediad at Journey Planner drwy deledu digidol?</a></p>
<div align="right"><a name="EnablingIntelligentTravel"></a><a class="jpt" href="#logoTop">Yn &#244;l i''r brig <img alt="Yn cl &#13;&#10;i&#8217;r brig" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
<h2>7. Air</h2></div>
<br />
<h3><a class="QuestionLink" id="A7.1" name="A7.1">7.1) How do you calculate journey times for flights?</a></h3>
...
<h2>7. Awyr</h2></div>
<br />
<h3><a class="QuestionLink" id="A7.1" name="A7.1">7.1) Sut ydych chi''n cyfrif amserau Siwrnai ar gyfer ehediadau?</a></h3>
...
<h2>8. Bus</h2></div>
<br />
<h3><a class="QuestionLink" id="A8.1" name="A8.1">8.1) How can I find out about buses that need to be booked in advance?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A8.2" name="A8.2">8.2) Can I plan a bus journey?</a></h3>
<ul>
...
<h3><a class="QuestionLink" id="A8.3" name="A8.3">8.3) How accurate are bus times?</a></h3>
...
<h3><a class="QuestionLink" id="A8.4" name="A8.4">8.4) What is the English Concessionary Travel Scheme?</a></h3>
<p>
...
<h3><a class="QuestionLink" id="A8.5" name="A8.5">8.5) Which bus services on Transport Direct are included in the English Concessionary Travel Scheme?</a></h3>
...
<h3><a class="QuestionLink" id="A8.6" name="A8.6">8.6) What is the Scottish Concessionary Travel Scheme?</a></h3>
...
<h3><a class="QuestionLink" id="A8.7" name="A8.7">8.7) What is the Welsh Concessionary Travel Scheme?</a></h3>
...
<h2>8. Bws</h2></div>
<br />
<h3><a class="QuestionLink" id="A8.1" name="A8.1">8.1) Sut y gallaf ddarganfod am fysiau y mae angen archebu lle ymlaen llaw arnynt?</a></h3>
...
<h3><a class="QuestionLink" id="A8.2" name="A8.2">8.2) A allaf i gynllunio siwrnai fws?</a></h3>
<ul>
...
<h3><a class="QuestionLink" id="A8.3" name="A8.3">8.3) Pa mor gywir yw''r amserau bws?</a></h3>
...
<h3><a class="QuestionLink" id="A8.4" name="A8.4">8.4) Beth yw Cynllun Teithio Rhatach Lloegr?</a></h3>
...
<h3><a class="QuestionLink" id="A8.5" name="A8.5">8.5) Pa wasanaethau bysiau Transport Direct sy''n gynwysedig yng Nghynllun Teithio Rhatach Lloegr?</a></h3>
...
<h3><a class="QuestionLink" id="A8.6" name="A8.6">8.6) Beth yw Cynllun Teithio Rhatach yr Alban?</a></h3>
...
<h3><a class="QuestionLink" id="A8.7" name="A8.7">8.7) Beth yw Cynllun Teithio Rhatach Cymru?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A12.1" name="A12.1">12.1)&nbsp;How do you estimate my car''s CO2 emissions?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A12.1" name="A12.1">12.1)&nbsp;Sut ydych chi''n amcangyfrif allyriadau CO2 fy nghar?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A12.2" name="A12.2">12.2)&nbsp;What assumptions do you make about cars" CO2 emissions?</a></h3>
...
<p>&nbsp;</p>
<p><a href="../Downloads/TransportDirectCO2Data.pdf" target="_child">Click here to see the assumptions we make about the miles per gallon for different sized engines <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(opens in new window)">.</a></p>
<p><br /></p>
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A12.3" name="A12.3">12.3) What assumptions do you make in estimating the CO2 emissions produced for your public transport and air journeys?</a></h3>
...
<p>Currently these figures are general averages for each type of public transport. Each figure assumes an average number of passengers for the typical sort of vehicles used when travelling by the particular type of transport. The figures come from Department for Transport (DfT) and have been agreed with Department for Environment Food and Rural Affairs (DEFRA)'
   UPDATETEXT [dbo].[tblContent].[Value-En] @ptrValText NULL 0 '. <a href="../Downloads/TransportDirectCO2Data.pdf" target="_child">Click here to see these figures <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(opens in new window)">.</a></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>For a plane journey we know the distance as the crow flies between the two airports you will fly between. We take this distance and multiply this by 1.09 to take account of the additional circling that a typical plane will do around take off and landing. This figure comes from Department of Transport (DfT) and has been agreed with the Department of Environment Food and Rural Affairs (DEFRA).</p>
<p>&nbsp;</p>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A12.4" name="A12.4">12.4) What assumptions do you make in comparing CO2 emissions for car journeys with public transport journeys?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A12.5" name="A12.5">12.5) What assumptions do you make about bus and coach journeys?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A12.6" name="A12.6">12.6) Why do you use the same colours as the Energy Efficiency Ratings?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A12.2" name="A12.2">12.2)&nbsp;Beth ydych chi''n ei dybio am allyriadau CO2 ceir?</a></h3>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br /><a href="../Downloads/TransportDirectCO2Data_CY.pdf" target="_child">Cliciwch yma i weld beth rydym yn ei dybio am y milltiroedd y galwyn ar gyfer moduron o wahanol faint <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(yn agor ffenestr newydd)">.</a></p>
<p><br /></p>
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A12.3" name="A12.3">12.3) Beth ydych chi''n ei dybio wrth amcangyfrif yr allyriadau CO2 a gynhyrchir ar gyfer siwrneiau trafnidiaeth gyhoeddus ac awyr?</a></h3>
...
<p><br />Ar hyn o bryd, mae''r ffigurau hyn yn gyfartalion cyffredinol ar gyfer pob math o drafnidiaeth gyhoeddus. Mae pob ffigur yn tybio nifer gyfartalog o deithwyr ar gyfer y math nodweddiadol o gerbydau a ddefnyddir wrth deithio gyda''r math penodol o drafnidiaeth. Daw''r ffigurau o''r Adran Drafnidiaeth ac fe''u cytunwyd &#226; DEFRA.&nbsp;<a href="../Downloads/TransportDirectCO2Data_CY.pdf" target="_child">Cliciwch yma i weld y ffigurau hyn <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(yn agor ffenestr newydd)">.</a></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<br />
<h3><a class="QuestionLink" id="A12.4" name="A12.4">12.4) Beth ydych chi''n ei dybio wrth gymharu allyriadau CO2 ar gyfer siwrneiau car &#226; siwrneiau trafnidiaeth gyhoeddus?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A12.5" name="A12.5">12.5) Beth ydych chi''n ei dybio am siwrneiau bws a choets?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A12.6" name="A12.6">12.6) Pam ydych chi''n defnyddio cyfraddau effeithlonrwydd ynni?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A15.1" name="A15.1">15.1)&nbsp;What can I do if I have a problem with this website or the information it has provided me with?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A15.1" name="A15.1">15.1)&nbsp;Beth y gallaf ei wneud os oes gennyf broblem gyda&#8217;r wefan hon neu&#8217;r wybodaeth y mae wedi ei rhoi i mi?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A11.1" name="A11.1">11.1)&nbsp;Once I&#8217;ve found a journey, can I find out what the fare is?</a></h3>
...
<h3><a class="QuestionLink" id="A11.2" name="A11.2">11.2)&nbsp;Can I find information about bus fares?</a></h3>
...
<h3><a class="QuestionLink" id="A11.3" name="A11.3">11.3)&nbsp;How can I find out how much the fuel will cost for a car journey?</a></h3>
...
<div><br /></div>
<h3><a class="QuestionLink" id="A11.4" name="A11.4">11.4)&nbsp;How can I find out the full costs of a car journey taking into account how much I have to pay to own and run a car?</a></h3>
...
<div><br /></div>
<h3><a class="QuestionLink" id="A11.5" name="A11.5">11.5)&nbsp;What types of rail fares can I see on the Journey Planner?</a></h3>
...
<div><br /></div>
<h3><a class="QuestionLink" id="A11.6" name="A11.6">11.6)&nbsp;What rail fares are shown in advance of a fares change?</a></h3>
...
<div><br /></div>
<h3><a class="QuestionLink" id="A11.7" name="A11.7">11.7)&nbsp;What is meant by &#8216;Route&#8217; in the list of rail fares shown for a journey?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A11.1" name="A11.1">11.1)&nbsp;Wedi i mi ddarganfod siwrnai, fedra&#8217; i ddarganfod beth yw pris y tocyn?</a></h3>
<p></p>
...
<p></p>
<h3><a class="QuestionLink" id="A11.2" name="A11.2">11.2)&nbsp;Fedra" i gael gwybodaeth am brisiau tocynnau bws?</a></h3>
...
<h3><a class="QuestionLink" id="A11.3" name="A11.3">11.3) Sut y gallaf ddarganfod faint y bydd y tanwydd yn ei gostio am siwrnai mewn car?</a></h3>
...
<div><br /></div>
<h3><a class="QuestionLink" id="A11.4" name="A11.4">11.4) Sut y gallaf ddarganfod costau llawn siwrnai car gan roi ystyriaeth i faint mae&#8217;n rhaid i mi ei dalu i fod yn berchen ar a chynnal car?</a></h3>
...
<div><br /></div>
<h3><a class="QuestionLink" id="A11.5" name="A11.5">11.5)&nbsp;Pa fathau o docynnau rheilffordd y gallaf eu gweld ar Journey Planner?</a></h3>
...
<div><br /></div>
<h3><a class="QuestionLink" id="A11.6" name="A11.6">11.6)&nbsp;Pa brisiau tocynnau rheilffordd a ddangosir cyn unrhyw newid mewn prisiau tocynnau?</a></h3>
...
<div><br /></div>
<h3><a class="QuestionLink" id="A11.7" name="A11.7">11.7)&nbsp;Beth yw ystyr &#8216;Llwybr&#8217; yn y rhestr o brisiau tr&#234;n a ddangosir ar gyfer siwrnai?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A1.1" name="A1.1">1.1)&nbsp;How much of Britain does the Journey Planner cover?</a></h3>
...
<p>&nbsp;</p>
<br />
<h3><a class="QuestionLink" id="A1.2" name="A1.2">1.2)&nbsp;Where does the Journey Planner get its information?</a></h3>
...
<p>&nbsp;</p>
<br />
<h3><a class="QuestionLink" id="A1.3" name="A1.3">1.3)&nbsp;Is the information on the Journey Planner accurate?</a></h3>
...
<p>&nbsp;</p>
<br />
<h3><a class="QuestionLink" id="A1.4" name="A1.4">1.4)&nbsp;How often is the information on the Journey Planner updated?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A1.5" name="A1.5">1.5)&nbsp;What can I do if I know of information that is missing or find inaccurate information?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A1.6" name="A1.6">1.6)&nbsp;How do I find out more about Transport Direct?</a></h3>
<p>For further information on Transport Direct please visit <a href="http:\\www.dft.gov.uk/transportdirect" target="_child">www.dft.gov.uk/transportdirect <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(opens in new window)"></a>. This website provides all the information on the set up of Transport Direct.</p>
<p>&nbsp;</p>
</div></div>', 
'<div id="primcontent">
<div id="contentarea">
...
<h3><a class="QuestionLink" id="A1.1" name="A1.1">1.1)&nbsp;Faint o Brydain y mae Journey Planner yn ymdrin ag ef?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A1.2" name="A1.2">1.2) O ble y caiff Journey Planner ei wybodaeth?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A1.3" name="A1.3">1.3) A yw&#8217;r wybodaeth ar Journey Planner yn gywir?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A1.4" name="A1.4">1.4) Pa mor aml y mae&#8217;r wybodaeth ar Journey Planner yn cael ei diweddaru?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A1.5" name="A1.5">1.5) Beth alla&#8217; i ei wneud os ydw i&#8217;n gwybod am wybodaeth sydd ar goll neu yn dod o hyd i wybodaeth sy&#8217;n anghywir?</a></h3>
...
<li>Llenwch y ffurflen "Adborth"</li></ul>
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A1.6" name="A1.6">1.6)&nbsp;Sut ydw i''n cael rhagor o wybodaeth am Journey Planner?</a></h3>
<p>For further information on Transport Direct please visit <a href="http:\\www.dft.gov.uk/transportdirect" target="_child">www.dft.gov.uk/transportdirect <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(opens in new window)"></a>. This website provides all the information on the set up of Transport Direct.</p>
<p>&nbsp;</p>
</div></div>
'
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.5">2.5) How do I add specific details or set travel preferences for my journeys?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.6">2.6) How can I plan a day trip to two destinations?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.7">2.7) How do I add a connecting journey to my overall journey?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.8">2.8) If I add a connecting public transport journey to a car/taxi journey, how can I make sure I have enough time to park my car/pay the taxi fare before boarding the train?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.9">2.9) How do I change the leaving or arrival times for the start or the end of my journey?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.10">2.10) How is the Journey Planner (Powered By) different from other journey planners?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.11">2.11) How can I find out about the accessibility of the types of transport in the journey?</a></p>
...
<br />
<h3><a class="QuestionLink" id="A2.1" name="A2.1">2.1) Which journey planner should I use?</a></h3>
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.4">2.4) Sut ydw i''n dod o hyd i orsaf neu faes awyr?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.5">2.5) Sut y gallaf ychwanegu manylion penodol neu osod hoffterau teithio ar gyfer fy siwrneion?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.6">2.6) Sut y gallaf gynllunio taith dydd i ddau gyrchfan?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.7">2.7) Sut y gallaf ychwanegu siwrnai gysylltiol at fy siwrnai gyffredinol?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.8">2.8) Pe byddwn yn ychwanegu siwrnai trafnidiaeth gyhoeddus gysylltiol at siwrnai gar/tacsi, sut y gallaf sicrhau bod gennyf ddigon o amser i barcio fy nghar/talu am y tacsi cyn mynd ar y tr&#234;n?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.9">2.9) Sut ydw i''n newid amserau gadael neu gyrraedd ar gyfer dechrau neu ddiwedd fy siwrnai?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.10">2.10) Sut mae Transport Direct yn wahanol i gynllunwyr siwrneion eraill?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.11">2.11) Sut y gallaf ddarganfod am hygyrchedd y mathau o gludiant yn y siwrnai?</a></p>
<p>&nbsp;</p>
<div>&nbsp;</div>
<div class="hdtypethree">
<h2>2. Cynllunio Siwrnai Cyffredinol</h2></div>
<h3><a class="QuestionLink" id="A2.1" name="A2.1">2.1) Pa gynlluniwr siwrnai y dylwn ei ddefnyddio?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.2" name="A2.2">2.2) How do I plan a journey using the Journey Planner?</a></h3>
...
<p>&nbsp;</p>
<br />
<h3><a class="QuestionLink" id="A2.3" name="A2.3">2.3) What if I don''t know the exact address(es) of where I want to travel from or to?</a></h3>
...
<h3><a class="QuestionLink" id="A2.4" name="A2.4">2.4) How do I find a stat'
   UPDATETEXT [dbo].[tblContent].[Value-En] @ptrValText NULL 0 'ion or an airport?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.5" name="A2.5">2.5) How do I add specific details or set travel preferences for my journeys?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.6" name="A2.6">2.6) How can I plan a day trip to two destinations?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.7" name="A2.7">2.7) How do I add a connecting journey to my overall journey?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.8" name="A2.8">2.8) If I add a connecting public transport journey to a car/taxi journey, how can I make sure I have enough time to park my car/pay the taxi fare before boarding the train? </a></h3>
...
<br />
<h3><a class="QuestionLink" id="A2.9" name="A2.9">2.9) How do I change the leaving or arrival times for the start or the end of my journey?</a></h3>
<ol>
...
<h3><a class="QuestionLink" id="A2.10" name="A2.10">2.10) How is The Journey Planner (Powered by Transport Direct) different from other journey planners?</a></h3>
<ul class="listerdisc">
...
<h3><a class="QuestionLink" id="A2.11" name="A2.11">2.11) How can I find out about the accessibility of the types of transport in the journey?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.2" name="A2.2">2.2) Sut ydw i&#8217;n cynllunio siwrnai yn defnyddio Journey Planner?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.3" name="A2.3">2.3) Beth os nad ydw i&#8217;n gwybod yr union gyfeiriad(au) y lle yr ydw i eisiau teithio ohono neu iddo? </a></h3>
...
<h3><a class="QuestionLink" id="A2.4" name="A2.4">2.4) Sut ydw i''n dod o hyd i orsaf neu faes awyr?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.5" name="A2.5">2.5) Sut y gallaf ychwanegu manylion penodol neu osod hoffterau teithio ar gyfer fy siwrneion?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.6" name="A2.6">2.6) Sut y gallaf gynllunio taith dydd i ddau gyrchfan?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.7" name="A2.7">2.7) Sut y gallaf ychwanegu siwrnai gysylltiol at fy siwrnai gyffredinol? </a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.8" name="A2.8">2.8) Pe byddwn yn ychwanegu siwrnai trafnidiaeth gyhoeddus gysylltiol at siwrnai gar/tacsi, sut y g'
   UPDATETEXT [dbo].[tblContent].[Value-Cy] @ptrValText NULL 0 'allaf sicrhau bod gennyf ddigon o amser i barcio fy nghar/talu am y tacsi cyn mynd ar y tr&#234;n?</a> </h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.9" name="A2.9">2.9) Sut ydw i''n newid yr amserau gadael neu gyrraedd ar gyfer dechrau neu ddiwedd fy siwrnai?</a></h3>
<ol>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.10" name="A2.10">2.10) Sut mae Journey Planner yn wahanol i gynllunwyr siwrneion eraill?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A2.11" name="A2.11">2.11) Sut y gallaf ddarganfod am hygyrchedd y mathau o gludiant yn y siwrnai?</a> </h3>
    <p>Transport direct provides three types of accessibility information which may be useful for travellers with disabilities.</p><p>&nbsp;</p>
    <p>
        Links to DPTAC (Disabled Persons Travel Advisory Committee) pages can be found in
        the left hand menu of journey entry pages and from the Notes section at the end
...
<br />
<h3><a class="QuestionLink" id="A9.1" name="A9.1">9.1)&nbsp;Can I get up-to-date travel news in my region?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A9.2" name="A9.2">9.2)&nbsp;How often is "Live travel" information updated?</a></h3>
<ul class="lister">
...
<p>&nbsp;</p>
<br />
<h3><a class="QuestionLink" id="A9.3" name="A9.3">9.3)&nbsp;How can I see a live departure board?</a></h3>
...
<li>Follow the instructions&nbsp;given on that site. </li> 
<li>Once you have finished viewing the departure board information, you may return to the Journey Planner site by closing the browser window.</li></ol></div><br />
<p>&nbsp;</p></div></div>
<div></div>
<div></div>
<div></div>
...
<br />
<h3><a class="QuestionLink" id="A9.1" name="A9.1">9.1)&nbsp;Fedra&#8217; i gael y newyddion diweddaraf am deithio yn fy rhanbarth i?</a></h3>
...
<h3><a class="QuestionLink" id="A9.2" name="A9.2">9.2)&nbsp;Pa mor aml y mae gwybodaeth "Teithio Byw" yn cael ei diweddaru?</a></h3>
<ul class="lister">
...
<br />
<h3><a class="QuestionLink" id="A9.3" name="A9.3">9.3)&nbsp;Sut allaf i weld bwrdd ymadael byw?</a></h3>
...
<h2>10. Maps</h2></div>
<p></p>
<h3><a class="QuestionLink" id="A10.1" name="A10.1">10.1) How do I find a place on a map?</a>&nbsp;</h3>
...
<p></p>
<h3><a class="QuestionLink" id="A10.2" name="A10.2">10.2)&nbsp;How can I see a map of incidents in my area?</a></h3>
...
<p></p>
<h3><a class="QuestionLink" id="A10.3" name="A10.3">10.3)&nbsp;How do I find a map that shows traffic levels?</a></h3>
...
<h3><a class="QuestionLink" id="A10.4" name="A10.4">10.4)&nbsp;How do I find a public transport network map?</a></h3>
<p>Open "Find a Place"</p>
<p>&nbsp;</p>
...
<h2>10. Mapiau</h2></div>
<br />
<h3><a class="QuestionLink" id="A10.1" name="A10.1">10.1) Sut ydw i&#8217;n dod o hyd i le ar y map?</a></h3>
...
<h3><a class="QuestionLink" id="A10.2" name="A10.2">10.2) Sut y gallaf weld map o ddigwyddiadau yn fy ardal?</a></h3>
...
<p></p>
<h3><a class="QuestionLink" id="A10.3" name="A10.3">10.3)&nbsp;Sut ydw i&#8217;n dod o hyd i fap sy&#8217;n dangos lefelau traffig?</a></h3>
...
<p></p>
<h3><a class="QuestionLink" id="A10.4" name="A10.4">10.4)&nbsp;Sut ydw i''n dod o hyd i fap rhwydwaith trafnidiaeth gyhoeddus?</a></h3>
<p>Agorwch "Canfyddwch le".</p>
<p>&nbsp;</p>
...
<div>&nbsp;</div>
<div class="hdtypethree">
<h2>14. Using the Journey Planner services on your PDA/Mobile/Digital TV</h2></div>
<br />
<h3><a class="QuestionLink" id="A14.1" name="A14.1">14.1)&nbsp;How can I use the latest PDAs or mobile phones to find out the departure and arrival times for railway stations throughout Britain and for some bus or coach stops in areas where SMS codes are available for the bus or coach stop?</a></h3>
...
<ul class="sublister">
    ...
    <br />
<h3><a class="QuestionLink" id="A14.2" name="A14.2">14.2)&nbsp;How can I use the latest PDAs or mobile phones to view Live travel news for public transport or car (e.g. check for delays and incidents) either for a region or for the whole of Britain?</a></h3>
<p>You can learn how to use these services on a PDA by using the PDA simulator which can be found on the "Tips &amp; tools" page, reached by clicking the tab at the top of the website.</p><br />
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A14.3" name="A14.3">14.3)&nbsp;How can I use the latest PDAs or mobile phones to find out whether there is a taxi rank or cab (private hire car) firm at the railway station I am travelling to, and get phone numbers for taxi or cab firms serving the station?</a></h3>
<p>You can learn how to use these services on a PDA by using the PDA simulator which can be found on the "Tips &amp; tools" page, reached by clicking the tab at the top of the website.</p><br />
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A14.4" name="A14.4">14.4)&nbsp;How can I access the Journey Planner on digital television?</a></h3>
<p>The Journey Planner is available via digital TV on Sky, cable and freeview boxes provided they have a modem or broadband telephone connection. Using your remote control you can access &#8216;real-time&#8217; train information and bus timetables as well as the latest transport and traffic news from the comfort of your sofa. <a href="/Web2/Tools/Home.aspx">See our &#8216;Tips and tools&#8217; section for further information.</a></p>
<p>&nbsp;</p></div></div>
<div></div>
<div></div>
<div></div>
...
<div>&nbsp;</div>
<div class="hdtypethree">
<h2>14. Defnyddio gwasanaethau teithio byw Journey Planner ar PDA/ffôn symudol/Teledu Digidol</h2></div>
<br />
<h3><a class="QuestionLink" id="A14.1" name="A14.1">14.1)&nbsp;Sut y gallaf ddefnyddio&#8217;r PDAs neu&#8217;r ffonau symudol diweddaraf i ddarganfod amserau ymadael a chyrraedd ar gyfer gorsafoedd rheilffordd ledled Prydain ac ar gyfer rhai arosfannau bysiau neu fysiau moethus mewn ardaloedd lle mae codau SMS ar gael ar gyfer yr arhosfan bysiau neu fysiau moethus?</a></h3>
...
<ul class="sublister">
    ...
    <br />
<h3><a class="QuestionLink" id="A14.2" name="A14.2">14.2)&nbsp;Sut y gallaf ddefnyddio PDAs neu&#8217;r ffonau symudol ddiweddaraf i edrych ar Newyddion Teithio Byw ar gyfer cludiant cyhoeddus neu gar (e.e. edrychwch a oes unrhyw oedi ac unrhyw ddigwyddiadau) naill ai ar gyfer rhanbarth neu ar gyfer Prydain gyfan?</a></h3>
<p>Gallwch ddysgu sut i ddefnyddio&#8217;r gwasanaethau hyn ar PDA drwy ddefnyddio&#8217;r efelychydd PDA, y gellir ei weld ar y dudalen Awgrymiadau a theclynnau, a gyrhaeddir drwy glicio ar y tab ar frig y wefan.</p><br />
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A14.3" name="A14.3">14.3)&nbsp;Sut y gallaf ddefnyddio&#8217;r PDAs neu&#8217;r ffonau symudol diweddaraf i ddarganfod a oes ranc tacsi neu gwmni cabiau (ceir hurio preifat) yn yr orsaf rheilffordd yr wyf yn teithio iddi, ac i gael rhifau ff&#244;n ar gyfer cwmn&#239;au tacsi neu gabiau sy&#8217;n gwasanaethu&#8217;r orsaf?</a></h3>
<p>Gallwch ddysgu sut i ddefnyddio&#8217;r gwasanaethau hyn ar PDA drwy ddefnyddio&#8217;r efelychydd PDA, y gellir ei weld ar y dudalen Awgrymiadau a theclynnau, a gyrhaeddir drwy glicio ar y tab ar frig y wefan.</p><br />
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A14.4" name="A14.4">14.4)&nbsp;Sut allaf i gael mynediad at Journey Planner drwy deledu digidol?</a></h3>
<p>Mae Journey Planner ar gael drwy deledu digidol ar Sky, teledu cebl a blychau Freeview cyhyd â bod ganddynt fodem neu gysylltiad ffôn band-eang. Gan ddefnyddio eich teclyn rheoli o bell, gallwch gael mynediad at wybodaeth "amser real" am drenau ac amserlenni bws yn ogystal â"r newyddion diweddaraf am draffig a thrafnidiaeth o gysur eich sedd feddal. <a href="/Web2/Tools/Home.aspx">Gweler ein hadran "Awgrymiadau a theclynnau" am wybodaeth bellach.</a></p>
<p>&nbsp;</p>
<p>&nbsp;</p></div></div>
<div></div>'
...
<h2>6. Parking</h2></div>
<br />
<h3><a class="QuestionLink" id="A6.1" name="A6.1">6.1) How do I find a car park?</a></h3>
<p><strong>Step 1: Open &#8216;Find a place&#8217;</strong></p>
<ul class="lister">
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A6.2" name="A6.2">6.2) How can I find out about Park and Ride schemes?</a></h3>
...
<h3><a class="QuestionLink" id="A6.3" name="A6.3">6.3) How can I plan a Park and Ride journey?</a></h3>
...
<h3><a class="QuestionLink" id="A6.4" name="A6.4">6.4)&nbsp;Where does car park data come from?</a></h3>
...
<h3><a class="QuestionLink" id="A6.5" name="A6.5">6.5)&nbsp;What is the Park Mark scheme?</a></h3>
...
<h2>6. Parcio</h2></div>
<br />
<h3><a class="QuestionLink" id="A6.1" name="A6.1">6.1) Sut y gallaf ddod o hyd i faes parcio?</a></h3>
<p><strong>Cam 1: Agorwch &#8216;Canfyddwch le&#8217;</strong></p>
<ul class="lister">
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A6.2" name="A6.2">6.2) Sut y gallaf ddarganfod gwybodaeth am gynlluniau Parcio a Theithio?</a> </h3>
<p></p>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A6.3" name="A6.3">6.3) Sut y gallaf gynllunio siwrnai Parcio a Theithio?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A6.4" name="A6.4">6.4) O ble y daw data am feysydd parcio?</a></h3>
...
<h3><a class="QuestionLink" id="A6.5" name="A6.5">6.5) Beth yw''r cynllun Park Mark?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A4.1" name="A4.1">4.1) Are all journeys planned by the quickest route?</a></h3>
...
<h3><a class="QuestionLink" id="A4.2" name="A4.2">4.2) How do I avoid particular roads?</a></h3>
...
<h3><a class="QuestionLink" id="A4.3" name="A4.3">4.3) How do I choose particular roads to use?</a></h3>
...
<h3><a class="QuestionLink" id="A4.4" name="A4.4">4.4) How do I avoid all motorways?</a></h3>
...
<h3><a class="QuestionLink" id="A1.4.5" name="A4.5">4.5) How do I find a car/taxi route that avoids all tolls or ferries?</a></h3>
...
<h3><a class="QuestionLink" id="A4.6" name="A4.6">4.6) How do you calculate car journey times?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A4.1" name="A4.1">4.1) A yw''r holl siwrneion yn cael eu cynllunio yn ôl y llwybr cyflymaf?</a></h3>
...
<h3><a class="QuestionLink" id="A4.2" name="A4.2">4.2) Sut y gallaf osgoi ffyrdd penodol?</a></h3>
...
<h3><a class="QuestionLink" id="A4.3" name="A4.3">4.3) Sut y dewisaf ffyrdd penodol i&#8217;w defnyddio? </a></h3>
...
<h3><a class="QuestionLink" id="A4.4" name="A4.4">4.4) Sut ydw i''n osgoi''r traffyrdd i gyd?</a></h3>
...
<h3><a class="QuestionLink" id="A4.5" name="A4.5">4.5) Sut rwy&#8217;n dod o hyd i lwybr car sy&#8217;n osgoi pob toll neu fferi?</a></h3>
...
<h3><a class="QuestionLink" id="A4.6" name="A4.6">4.6) Sut ydych chi''n cyfrif amserau siwrneion car?</a></h3>
...
<h2>5. Taxis</h2></div>
<br />
<h3><a class="QuestionLink" id="A5.1" name="A5.1">5.1) How can I find taxi information for stations I am travelling to in my journey?</a></h3>
...
<h3><a class="QuestionLink" id="A5.2" name="A5.2">5.2) Can I find out if the taxis are wheelchair accessible?</a></h3>
...
<h2>5. Tacsis</h2></div>
<br />
<h3><a class="QuestionLink" id="A5.1" name="A5.1">5.1) Sut y gallaf ddarganfod gwybodaeth am dacsis ar gyfer gorsafoedd rwyf yn teithio iddynt yn ystod fy siwrnai?</a></h3>
...
<h3><a class="QuestionLink" id="A5.2" name="A5.2">5.2) Fedra" i ddarganfod a yw''r tacsis yn hygyrch i gadeiriau olwyn?</a></h3>
...
<h2>3. Train</h2></div>
<br />
<h3><a class="QuestionLink" id="A3.1" name="A3.1">3.1) How can I find departure times for the stations listed in my journey?</a></h3>
...
<h3><a class="QuestionLink" id="A3.2" name="A3.2">3.2) How can I find out what stations my train will be stopping at?</a></h3>
...
<h3><a class="QuestionLink" id="A3.3" name="A3.3">3.3) How can I find information about train operators?</a></h3>
...
<h3><a class="QuestionLink" id="A3.4" name="A3.4">3.4) How can I find out what on-board facilities will be available on a train?</a></h3>
...
<h3><a class="QuestionLink" id="A3.5" name="A3.5">3.5) How can I find out if I need to or can make a reservation in advance on a train?</a></h3>
...
<h3><a class="QuestionLink" id="A3.6" name="A3.6">3.6) How can I find out which classes of travel are available on a train?</a></h3>
...
<h3><a class="QuestionLink" id="A3.7" name="A3.7">3.7) How can I find out about station accessibility and facilities at railway stations on my journey?</a></h3>
...
<h3><a class="QuestionLink" id="A3.8" name="A3.8">3.8) How can I get a list of all the direct rail services to a destination (including overtaken services), rather than just the fastest ones?</a></h3>
...
<h3><a class="QuestionLink" id="A3.9" name="A3.9">3.9) How do I plan a journey to or from an underground/light rail station?</a></h3>
...
<h2>3. Tr&#234;n</h2></div>
<br />
<h3><a class="QuestionLink" id="A3.1" name="A3.16">3.1) Sut y gallaf ddarganfod amserau ymadael ar gyfer y gorsafoedd a restrwyd yn fy siwrnai?</a></h3>
...
<h3><a class="QuestionLink" id="A3.2" name="A3.2">3.2) Sut y gallaf ddarganfod pa orsafoedd y bydd fy nhr&#234;n i yn aros ynddynt?</a></h3>
...
<h3><a class="QuestionLink" id="A3.3" name="A3.3">3.3) Sut y gallaf ddarganfod gwybodaeth am weithredwyr trenau?</a></h3>
...
<h3><a class="QuestionLink" id="A3.4" name="A3.4">3.4) Sut y gallaf ddarganfod pa gyfleusterau fydd ar gael ar dr&#234;n?</a></h3>
...
<h3><a class="QuestionLink" id="A3.5" name="A3.5">3.5) Sut y gallaf ddarganfod a oes arnaf angen neu os gallaf archebu lle ymlaen llaw ar dr&#234;n?</a></h3>
...
<h3><a class="QuestionLink" id="A3.6" name="A3.6">3.6) Sut y gallaf ddarganfod pa ddosbarthiadau o deithio sydd ar gael ar dr&#234;n?</a></h3>
...
<h3><a class="QuestionLink" id="A3.7" name="A3.7">3.7) Sut y gallaf ddarganfod am hygyrchedd gorsaf a&#8217;r cyfleusterau sydd ar gael ar fy siwrnai?</a></h3>
...
<h3><a class="QuestionLink" id="A3.8" name="A3.8">3.8) Sut y gallaf gael rhestr o''r holl wasanaethau rheilffordd uniongyrchol i gyrchfan, yn hytrach na dim ond y rhai cyflymaf?</a></h3>
...
<h3><a class="QuestionLink" id="A3.9" name="A3.9">3.9) Sut ydw i''n cynllunio siwrnai i orsaf dan ddaear/gorsaf drenau ysgafn neu oddi yno?</a></h3>
...
<br />
<h3><a class="QuestionLink" id="A13.1" name="A13.1">13.1)&nbsp;What browsers&nbsp;does the website work best on?</h3>
...
<h3><a class="QuestionLink" id="A13.1" name="A13.1">13.1) Pa borwyr y mae''r wefan yn gweithio orau arnynt?</a></h3>
<p>The Transport Direct website is designed to support the following browsers: Internet Explorer versions 6, 7 and 8, Firefox 3, Safari 4 and Chrome 9. Some of the interactive services may require you to switch on javascript and cookies in your browser for them to work as designed.</p>
<p>&nbsp;</p>
<p>If you are not using one of the browsers above you should be able to access the site and use the pages'
--DECLARE @ptrValText BINARY(16)
...
<p>&nbsp;</p>
<br />
<h3><a class="QuestionLink" id="A13.2" name="A13.2">13.2) Can I print information&nbsp;from the website?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A13.3" name="A13.3">13.3) How can I save my travel preferences and my favourite j'
   UPDATETEXT [dbo].[tblContent].[Value-En] @ptrValText NULL 0 'ourneys?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A13.4" name="A13.4">13.4) Can I bookmark certain journeys (save as favourites)?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A13.5" name="A13.5">13.5) Why should I register on Trans'
   UPDATETEXT [dbo].[tblContent].[Value-En] @ptrValText NULL 0 'port Direct?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A13.6" name="A13.6">13.6) How can I email information to other people?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A13.7" name="A13.7">13.7) What is the purpose of the Journey Planner Toolbar?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A13.8" name="A13.8">13.8) How can I add a Journey Planner link to my website?</a></h3>
...
<p><br /></p>
<br />
<h3><a class="QuestionLink" id="A13.9" name="A13.9">13.9) Do I need to have JavaScript enabled to use the Journey Planner?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.10" name="A13.10">13.10) Is the Journey Planner an accessible website?</a></h3>
...
<p><br />The Journey Planner website currently conforms to Level A of the Web Accessibility Guidelines (WAI) produced by the World Wide Web Consortium (W3C).</p>
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.11" name="A13.11">13.11)&nbsp;Why is my company browser blocking some Journey Planner functionality?</a></h3>
...
IF @ptrValText IS NOT NULL BEGIN
   ...
   UPDATETEXT [dbo].[tblContent].[Value-Cy] @ptrValText NULL 0 'x) brofi rhai problemau bychain gyda''r arddangosiad fel camaleinio testun mewn rhai rhannau o''r wefan. &nbsp;Bydd defnyddwyr gyda fersiynau uwch o Internet Explorer, Netscape a Firefox yn gweld y wefan fel y dyluniwyd hi.</p>
<p>&nbsp;</p>
<p>Nodwch nad yw''r safle yn cefnogi defnyddio Internet Explorer ar Macs.&nbsp; Argymhellwn fod defnyddwyr Mac yn defnyddio Macintosh Safari.</p>
<p>&nbsp;</p>
<p>Accessing the Journey Planner in more than one window within the same browser session may cause a serious error.&nbsp; In order to view the Journey Planner in more than one window please open a new browser session rather than opening a new window (or tab) within the same browser.</p>
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.2" name="A13.2">13.2) Alla&#8217; i argraffu gwybodaeth o&#8217;r wefan?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.3" name="A13.3">13.3) Sut y gallaf gadw fy hoffterau teithio a&#8217;m hoff siwrneion?</a>'
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.4" name="A13.4">13.4) Alla&#8217; i roi roi nod llyfr ar rai siwrneion (eu cadw fel ffefrynnau)?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.5" name="A13.5">13.5) Pam y dylwn gofrestru ar Journey Planner?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.6" name="A13.6">13.6) Sut y gallaf ebostio gwybodaeth i bobl eraill?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.7" name="A13.7">13.7) Beth yw pwrpas Bar Offer Journey Planner?</a></h3>
<p>Mae Bar Offe'
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.8" name="A13.8">13.8) Sut y gallaf ychwanegu cyswllt Journey Planner at fy ngwefan?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.9" name="A13.9">13.9) A oes angen i mi fod &#226; JavaScript wedi ei alluogi i ddefnyddio Journey Planner?</a></h3>
...
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.10" name="A13.10">13.10) A yw Journey Planner yn wefan hygyrch?</a></h3>
...
<p><br />Mae gwefan Journey Planner ar hyn o bryd yn cydymffurfio &#226; Lefel A Canllawiau Hygyrchedd y We (WAI) a gynhyrchwyd gan y Consortiwm y We Fyd-eang (W3C).</p>
<p>&nbsp;</p>
<h3><a class="QuestionLink" id="A13.11" name="A13.11">13.11)&nbsp;Pam fod porwr fy nghwmni yn rhwystro rhai swyddogaethau Journey Planner?</a></h3>
...
-- 
-- This section is ONLY applicable to the Visit Britain site
-------------------------------------------------------------
EXEC AddtblContent
@ThemeId, 19, 'Body Text', '/Channels/TransportDirect/Help/HelpTouristInfo', 
'<DIV id="primcontent">
	<DIV id="contentarea">
		<DIV id="hdtypethree"><A id="TouristInformation" name="TouristInformation"></A><h2>17. Transport Direct Tourist Information</h2>
		</DIV>
		...
		<P>
			<h3><A class="QuestionLink" id="A17.1" name="A17.1">17.1)&nbsp;How can I find travel 
					information when visiting from abroad?</A></h3>
		<P>Transport Direct currently covers travel across Great Britain (England, Wales 
			and Scotland); you can plan your GB journey on Transport Direct from any where 
			around the world.</P>
		<h3><A class="QuestionLink" id="A17.2" name="A17.2">17.2)&nbsp;How can I find tourist 
				information when visiting from abroad?</A></h3>
		<P>Information on tourist destinations and accommodation in Britain can be found at <A href="www.visitbritain.com" target="_child">
				www.visitbritain.com</A>.</P>
		<h3><A class="QuestionLink" id="A17.3" name="A17.3">17.3)&nbsp;Can I book tickets on 
				Transport Direct from abroad?</A></h3>
...
'<DIV id="primcontent">
	<DIV id="contentarea">
		<DIV id="hdtypethree"><A id="TouristInformation" name="TouristInformation"></A><h2>17. CY - Transport Direct 
				Tourist Information</h2>
		</DIV>
		<P class="rsviewcontentrow"><A href="/Web2/Help/HelpTouristInfo.aspx#A17.1">17.1)&nbsp;CY - 
				How can I find travel information when visiting from abroad?</A></P>
		<P class="rsviewcontentrow"><A href="/Web2/Help/HelpTouristInfo.aspx#A17.2">17.2)&nbsp;CY - 
				How can I find tourist information when visiting from abroad?</A></P>
		<P class="rsviewcontentrow"><A href="/Web2/Help/HelpTouristInfo.aspx#A17.3">17.3)&nbsp;CY - 
				Can I book tickets on Transport Direct from abroad?</A></P>
		<P>&nbsp;</P>
		<DIV id="hdtypethree">
			<H2>17. Transport Direct Tourist Information</H2>
		</DIV>
		<P>
			<h3><A class="QuestionLink" id="A2" name="A17.1">17.1)&nbsp;CY - How can I find travel 
					information when visiting from abroad?</A></h3>
		<P>Transport Direct currently covers travel across Great Britain (England, Wales 
			and Scotland); you can plan your GB journey on Transport Direct from any where 
			around the world.</P>
		<h3><A class="QuestionLink" id="A3" name="A17.2">17.2)&nbsp;CY - How can I find tourist 
				information when visiting from abroad?</A></h3>
		<P>Information on tourist destinations and accommodation in Britain can be found at <A href="www.visitbritain.com" target="_child">
				www.visitbritain.com</A>.</P>
		<h3><A class="QuestionLink" id="A4" name="A17.3">17.3)&nbsp;CY - Can I book tickets on 
				Transport Direct from abroad?</A></h3>
		<P>Yes, you can book tickets from abroad through our retail partners but tickets 
			may have to be collected at the relevant departure station.</P>
		<P>&nbsp;</P>
...
'<div><h1>Frequently Asked Questions (FAQ) - Using Transport Direct services on&nbsp;your PDA/Mobile/Digital TV </h1></div>',
'<div><h1>Cwestiynau a Ofynnir yn Aml (COA) - Defnyddio gwasanaethau teithio byw Transport Direct ar PDA/ff&#244;n symudol/Teledu Digidol </h1></div>'
...
SET @ScriptNumber = 10705
SET @ScriptDesc = 'Updates to FAQs - modified for London2012'


DECLARE @VersionInfo VARCHAR(24)
SET @VersionInfo = '$Revision:   1.18  $'
