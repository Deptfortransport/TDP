-- *************************************************************************************
-- NAME 		: SCP10405_BusinessGateway_5_FAQs.sql
-- DESCRIPTION  : FAQs (Full Set) - modified for BusinessGateway
-- AUTHOR		: XXXXXXXXX
-- *************************************************************************************

-- Section "14 Using the Journey Planner services on your PDA/Mobile" has been removed with subsequent sections renumbered
...
<div align="right"><a name="WhoOperates"></a><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
<div class="hdtypethree"><a id="CommentFeedback" name="CommentFeedback"></a><h2>14. Comment and feedback</h2></div>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpComm.aspx#A14.1">14.1)&nbsp;What can I do if I have a problem with this website or the information it has provided me with?</a></p>
...
<div class="hdtypethree"><a id="CyclePlanning" name="CyclePlanning"></a><h2>15. Cycle Planning</h2></div>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.1">15.1)&nbsp;Does Transport Direct offer cycling options?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.2">15.2)&nbsp;Which areas can I plan a cycle journey in?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.3">15.3)&nbsp;Are all journeys planned by the quickest route?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.4">15.4)&nbsp;I will be travelling when it’s dark, how do I try and ensure my journey goes through reasonably well lit areas?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.5">15.5)&nbsp;How do I plan a journey where I do not have to get off and on my bike?</a></p>
<!-- <p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.6">15.6)&nbsp;I’m planning a journey with my young children, how do I avoid cycle journeys with steep climbs?</a></p> -->
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.7">15.7)&nbsp;What are time-based restrictions and what impact could they have on my journey?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.8">15.8)&nbsp;How do you calculate cycle journey times?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.9">15.9)&nbsp;Why am I being asked to download Active X controls?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.10">15.10)&nbsp;What should I do if I am prompted to download the control?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.11">15.11)&nbsp;What should I do if I cannot see the graph and have not been prompted to download the ActiveX control?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.12">15.12)&nbsp;What is a GPX file?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.13">15.13)&nbsp;How does Transport Direct Calculate Calories used?</a></p>
<div align="right"><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>

<div class="hdtypethree"><a id="TouristInformation" name="TouristInformation"></a><h2>16. Transport Direct Tourist Information</h2></div>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.1">16.1)&nbsp;How can I find travel information when visiting from abroad?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.2">16.2)&nbsp;How can I find tourist information when visiting from abroad?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.3">16.3)&nbsp;Can I book tickets on Transport Direct from abroad?</a></p>
<div align="right"><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>

<div class="hdtypethree"><a id="AccessiblePlanning" name="AccessiblePlanning"></a><h2>17. Accessible Journey Planning</h2></div>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.1">17.1) What information do you provide about accessible services, and which areas are covered?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.2">17.2) How accurate is your information on accessible journeys?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.3">17.3) What do you mean by ''assistance''?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.4">17.4) Why do you include journey legs that require assistance in your ''step-free only'' results?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.5">17.5) Why do I need to book in advance?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.6">17.6) How can I book in advance?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.7">17.7) How does the ''Find Nearest Accessible Stop'' work?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.8">17.8) How can I get to the nearest accessible station or stop?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.9">17.9) Can I choose an accessible journey that only uses particular types of transport?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.10">17.10) Can I obtain more information about the accessibility of a station?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.11">17.11) Can you provide fares information?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.12">17.12) Why didn''t I get any results for my accessible journey?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.13">17.13) I don''t believe a service, station or stop included in your journey results is accessible.  Can you correct this?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.14">17.14) Can I use my mobility scooter on public transport?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.15">17.15) Why can''t I plan to an airport, even though I know it is accessible?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A17.16">17.16) How do I find out about live incidents on the transport network once my journey has started?</a></p>
<div align="right"><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpLiveTravel.aspx#A9.4">9.4) Sut allarf fi weld a oes unrhyw newyddion teithio yn effeithio ar fy nharith ar y ffordd?</a></p>
<div align="right"><a name="EnablingIntelligentTravel"></a><a class="jpt" href="#logoTop">Yn &#244;l i''r brig <img alt="Yn cl &#13;&#10;i&#8217;r brig" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
<div class="hdtypethree"><a id="CommentFeedback" name="CommentFeedback"></a><h2>14. Sylwadau ac adborth</h2></div>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpComm.aspx#A14.1">14.1) Beth y gallaf ei wneud os oes gennyf broblem gyda&#8217;r wefan hon neu&#8217;r wybodaeth y mae wedi ei rhoi i mi?</a></p>
<div align="right"><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>

<div class="hdtypethree"><a id="CyclePlanning" name="CyclePlanning"></a><h2>15. Trefnu Teithiau Beicio</h2></div>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.1">15.1)&nbsp;A yw Transport Direct yn cynnig dewisiadau beicio?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.2">15.2)&nbsp;Ym mha ardaloedd y gallaf gynllunio taith feicio? </a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.3">15.3)&nbsp;A yw pob siwrnai''n cael ei chynllunio yn &#244;l y llwybr cyflymaf?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.4">15.4)&nbsp;Byddaf yn teithio yn y tywyllwch, sut ydw i''n ceisio sicrhau bod fy siwrnai''n mynd drwy ardaloedd wedi''u goleuo''n rhesymol o dda?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.5">15.5)&nbsp;Sut ydw i''n trefnu siwrnai heb fod yn rhaid imi ddod oddi ar fy meic?</a></p>
<!-- <p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.6">15.6)&nbsp;Rwyf yn cynllunio siwrnai gyda fy mhlant ifanc, sut ydw i''n osgoi siwrneiau beicio sy''n dringo''n serth?</a></p> -->
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.7">15.7)&nbsp;Beth yw''r cyfyngiadau amser a pha effaith y gallent ei chael ar fy siwrnai?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.8">15.8)&nbsp;Sut ydych chi''n cyfrifo amseroedd siwrnai beicio?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.9">15.9)&nbsp;Pam mae gofyn imi lwytho rheolaethau Active X i lawr?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.10">15.10)&nbsp;Beth ddylwn ei wneud os gofynnir imi lwytho''r rheolaeth i lawr?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.11">15.11)&nbsp;Beth ddylwn ei wneud os nad wyf yn gallu gweld y graff ac os na ofynnwyd imi lwytho''r rheolaeth ActiveX i lawr?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.12">15.12)&nbsp;Beth yw ffeil GPX?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpCycle.aspx#A15.13">15.13)&nbsp;Sut mae Transport Direct yn Cyfrifo Calorïau a ddefnyddir?</a></p>
<div align="right"><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>

<div id="hdtypethree"><a id="TouristInformation" name="TouristInformation"></a><h2>16. Twrist Transport Direct </h2></div>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.1">16.1)&nbsp;Sut allaf i ddarganfod gwybodaeth am deithio pan fyddaf yn ymweld â''r wlad o dramor?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.2">16.2)&nbsp;Sut allaf i ddarganfod gwybodaeth i dwristiaid pan fyddaf yn ymweld â''r wlad o dramor?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.3">16.3)&nbsp;Allaf i archebu tocynnau ar Transport Direct o dramor?</a></p>
<div align="right"><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
<div>&nbsp;</div>
<div class="hdtypethree">
<h2>14. Comment and feedback</h2></div>
<br />
<h3><a class="QuestionLink" id="A14.1" name="A14.1"></a>14.1)&nbsp;What can I do if I have a problem with this website or the information it has provided me with?</h3>
...
<div>&nbsp;</div>
<div class="hdtypethree">
<h2>14. Sylwadau ac adborth</h2></div>
<br />
<h3><a class="QuestionLink" id="A14.1" name="A14.1"></a>14.1)&nbsp;Beth y gallaf ei wneud os oes gennyf broblem gyda&#8217;r wefan hon neu&#8217;r wybodaeth y mae wedi ei rhoi i mi?</h3>
...
<h2>3. Tr&#234;n</h2></div>
<br />
<h3><a class="QuestionLink" id="A3.1" name="A3.1"></a>3.1) Sut y gallaf ddarganfod amserau ymadael ar gyfer y gorsafoedd a restrwyd yn fy siwrnai?</h3>
...
'<div id="primcontent">
	<div id="contentarea">
		<div class="hdtypethree"><a id="TouristInformation" name="TouristInformation"></a><h2>16. Transport Direct Tourist Information</h2>
		</div>
		<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.1">16.1)&nbsp;How can 
				I find travel information when visiting from abroad?</a></p>
		<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.2">16.2)&nbsp;How can 
				I find tourist information when visiting from abroad?</a></p>
		<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.3">16.3)&nbsp;Can I 
				book tickets on Transport Direct from abroad?</a></p>
		<p>&nbsp;</p>
		<div class="hdtypethree">
			<h2>16. Transport Direct Tourist Information</h2>
		</div>
			<h3><a class="QuestionLink" id="A16.1" name="A16.1"></a>16.1)&nbsp;How can I find travel 
		...
		<p>Transport Direct currently covers travel across Great Britain (England, Wales 
			...
			around the world.</p>
		<h3><a class="QuestionLink" id="A16.2" name="A16.2"></a>16.2)&nbsp;How can I find tourist 
				information when visiting from abroad?</h3>
		...
		<h3><a class="QuestionLink" id="A16.3" name="A16.3"></a>16.3)&nbsp;Can I book tickets on 
...
'<div id="primcontent">
	<div id="contentarea">
		<div class="hdtypethree"><a id="TouristInformation" name="TouristInformation"></a><h2>16. Gwybodaeth i Dwristiaid - Transport Direct</h2>
		</div>
		<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.1">16.1)&nbsp;Sut allaf i ddarganfod gwybodaeth teithio pan fyddaf yn ymweld â''r wlad o dramor?</a></p>
		<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.2">16.2)&nbsp;Sut allaf i ddarganfod gwybodaeth i dwristiaid pan fyddaf yn ymweld â''r wlad o dramor?</a></p>
		<p class="rsviewcontentrow"><a href="/Web2/Help/HelpTouristInfo.aspx#A16.3">16.3)&nbsp;Allaf i archebu tocynnau ar Transport Direct o dramor?</a></p>
		<p>&nbsp;</p>
		<div class="hdtypethree">
			<h2>16. Gwybodaeth i Dwristiaid - Transport Direct</h2>
		</div>
			<h3><a class="QuestionLink" id="A2" name="A16.1"></a>16.1)&nbsp;Sut allaf i ddarganfod gwybodaeth teithio pan fyddaf yn ymweld â''r wlad o dramor?</h3>
		...
		<h3><a class="QuestionLink" id="A3" name="A16.2"></a>16.2)&nbsp;Sut allaf i ddarganfod gwybodaeth i dwristiaid pan fyddaf yn ymweld â''r wlad o dramor?</h3>
		<p>Gellir dod o hyd i wybodaeth am gyrchfannau twristaidd a llety ym Mhrydain yn <a href="http://www.visitbritain.com" target="_child">
				www.visitbritain.com <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(opens in new window)" /></a>.</p>
		<h3><a class="QuestionLink" id="A4" name="A16.3"></a>16.3)&nbsp;Allaf i archebu tocynnau ar Transport Direct o dramor?</h3>
...
<div id="contentarea">
<div class="hdtypethree"><a id="CyclePlanning" name="CyclePlanning"></a><h2>15. Cycle Planning</h2></div>
<p class="rsviewcontentrow"><a href="#A15.1">15.1)&nbsp;Does Transport Direct offer cycling options?</a></p>
<p class="rsviewcontentrow"><a href="#A15.2">15.2)&nbsp;Which areas can I plan a cycle journey in?</a></p>
<p class="rsviewcontentrow"><a href="#A15.3">15.3)&nbsp;Are all journeys planned by the quickest route?</a></p>
<p class="rsviewcontentrow"><a href="#A15.4">15.4)&nbsp;I will be travelling when its dark, how do I try and ensure my journey goes through reasonably well lit areas?</a></p>
<p class="rsviewcontentrow"><a href="#A15.5">15.5)&nbsp;How do I plan a journey where I do not have to get off and on my bike?</a></p>
<!-- <p class="rsviewcontentrow"><a href="#A15.6">15.6)&nbsp;I’m planning a journey with my young children, how do I avoid cycle journeys with steep climbs?</a></p> -->
<p class="rsviewcontentrow"><a href="#A15.7">15.7)&nbsp;What are time-based restrictions and what impact could they have on my journey?</a></p>
<p class="rsviewcontentrow"><a href="#A15.8">15.8)&nbsp;How do you calculate cycle journey times?</a></p>
<p class="rsviewcontentrow"><a href="#A15.9">15.9)&nbsp;Why am I being asked to download Active X controls?</a></p>
<p class="rsviewcontentrow"><a href="#A15.10">15.10)&nbsp;What should I do if I am prompted to download the control?</a></p>
<p class="rsviewcontentrow"><a href="#A15.11">15.11)&nbsp;What should I do if I cannot see the graph and have not been prompted to download the ActiveX control?</a></p>
<p class="rsviewcontentrow"><a href="#A15.12">15.12)&nbsp;What is a GPX file?</a></p>
<p class="rsviewcontentrow"><a href="#A15.13">15.13)&nbsp;How does Transport Direct Calculate Calories used?</a></p>
<div>&nbsp;</div>
<div class="hdtypethree"><h2>15. Cycle Planning</h2></div>
<br />
<h3><a class="QuestionLink" id="A15.1" name="A15.1"></a>15.1)&nbsp;Does Transport Direct offer cycling options?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.2" name="A15.2"></a>15.2)&nbsp;Which areas can I plan a cycle journey in?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.3" name="A15.3"></a>15.3)&nbsp;Are all journeys planned by the quickest route?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.4" name="A15.4"></a>15.4)&nbsp;I will be travelling when its dark, how do I try and ensure my journey goes through reasonably well lit areas?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.5" name="A15.5"></a>15.5)&nbsp;How do I plan a journey where I do not have to get off and on my bike?</h3>
...
<br />
<!-- <h3><a class="QuestionLink" id="A15.6" name="A15.6"></a>15.6)&nbsp;I’m planning a journey with my young children, how do I avoid cycle journeys with steep climbs?</h3>
...
<br /> -->
<h3><a class="QuestionLink" id="A15.7" name="A15.7"></a>15.7)&nbsp;What are time-based restrictions and what impact could they have on my journey?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.8" name="A15.8"></a>15.8)&nbsp;How do you calculate cycle journey times?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.9" name="A15.9"></a>15.9)&nbsp;Why am I being asked to download Active X controls?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.10" name="A15.10"></a>15.10)&nbsp;What should I do if I am prompted to download the control?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.11" name="A15.11"></a>15.11)&nbsp;What should I do if I cannot see the graph and have not been prompted to download the ActiveX control?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.12" name="A15.12"></a>15.12)&nbsp;What is a GPX file?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.13" name="A15.13"></a>15.13)&nbsp;How does Transport Direct Calculate Calories used?</h3>
...
<div id="contentarea">
<div class="hdtypethree"><a id="CyclePlanning" name="CyclePlanning"></a><h2>15. Trefnu Teithiau Beicio</h2></div>
<p class="rsviewcontentrow"><a href="#A15.1">15.1)&nbsp;A yw Transport Direct yn cynnig dewisiadau beicio?</a></p>
<p class="rsviewcontentrow"><a href="#A15.2">15.2)&nbsp;Ym mha ardaloedd y gallaf gynllunio taith feicio?</a></p>
<p class="rsviewcontentrow"><a href="#A15.3">15.3)&nbsp;A yw pob siwrnai''n cael ei chynllunio yn &#244;l y llwybr cyflymaf?</a></p>
<p class="rsviewcontentrow"><a href="#A15.4">15.4)&nbsp;Byddaf yn teithio yn y tywyllwch, sut ydw i''n ceisio sicrhau bod fy siwrnai''n mynd drwy ardaloedd wedi''u goleuo''n rhesymol o dda?</a></p>
<p class="rsviewcontentrow"><a href="#A15.5">15.5)&nbsp;Sut ydw i''n trefnu siwrnai heb fod yn rhaid imi ddod oddi ar fy meic?</a></p>
<!-- <p class="rsviewcontentrow"><a href="#A15.6">15.6)&nbsp;Rwyf yn cynllunio siwrnai gyda fy mhlant ifanc, sut ydw i''n osgoi siwrneiau beicio sy''n dringo''n serth?</a></p> -->
<p class="rsviewcontentrow"><a href="#A15.7">15.7)&nbsp;Beth yw''r cyfyngiadau amser a pha effaith y gallent ei chael ar fy siwrnai?</a></p>
<p class="rsviewcontentrow"><a href="#A15.8">15.8)&nbsp;Sut ydych chi''n cyfrifo amseroedd siwrnai beicio?</a></p>
<p class="rsviewcontentrow"><a href="#A15.9">15.9)&nbsp;Pam mae gofyn imi lwytho rheolaethau Active X i lawr?</a></p>
<p class="rsviewcontentrow"><a href="#A15.10">15.10)&nbsp;Beth ddylwn ei wneud os gofynnir imi lwytho''r rheolaeth i lawr?</a></p>
<p class="rsviewcontentrow"><a href="#A15.11">15.11)&nbsp;Beth ddylwn ei wneud os nad wyf yn gallu gweld y graff ac os na ofynnwyd imi lwytho''r rheolaeth ActiveX i lawr?</a></p>
<p class="rsviewcontentrow"><a href="#A15.12">15.12)&nbsp;Beth yw ffeil GPX?</a></p>
<p class="rsviewcontentrow"><a href="#A15.13">15.13)&nbsp;Sut mae Transport Direct yn Cyfrifo Calorïau a ddefnyddir?</a></p>
<div>&nbsp;</div>
<div class="hdtypethree"><h2>15. Trefnu Teithiau Beicio</h2></div>
<br />
<h3><a class="QuestionLink" id="A15.1" name="A15.1"></a>15.1)&nbsp;A yw Transport Direct yn cynnig dewisiadau beicio?</h3>
<p>Transport Direct has launched the first version of its new cycle planner. Currently, this allows you to plan cycle journeys between places that are up to 50km apart in the areas 
listed in FAQ 16.2 below. We are now encouraging users and experts to provide feedback about the new planner and the data that it uses.</p>
<br />
<h3><a class="QuestionLink" id="A15.2" name="A15.2"></a>15.2)&nbsp;Ym mha ardaloedd y gallaf gynllunio taith feicio? </h3>
<p>You can plan a cycle journey in areas listed below.</p>
<br />
<div class="clearboth divCycleAreas">
<table class="tableCycleAreas" width="100%" cellpadding="0" cellspacing="0">
...
<br />
<h3><a class="QuestionLink" id="A15.3" name="A15.3"></a>15.3)&nbsp;A yw pob siwrnai''n cael ei chynllunio yn &#244;l y llwybr cyflymaf?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.4" name="A15.4"></a>15.4)&nbsp;Byddaf yn teithio yn y tywyllwch, sut ydw i''n ceisio sicrhau bod fy siwrnai''n mynd drwy ardaloedd wedi''u goleuo''n rhesymol o dda?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.5" name="A15.5"></a>15.5)&nbsp;Sut ydw i''n trefnu siwrnai heb fod yn rhaid imi ddod oddi ar fy meic?</h3>
...
<br />
<!-- <h3><a class="QuestionLink" id="A15.6" name="A15.6"></a>15.6)&nbsp;Rwyf yn cynllunio siwrnai gyda fy mhlant ifanc, sut ydw i''n osgoi siwrneiau beicio sy''n dringo''n serth?</h3>
...
<br /> -->
<h3><a class="QuestionLink" id="A15.7" name="A15.7"></a>15.7)&nbsp;Beth yw''r cyfyngiadau amser a pha effaith y gallent ei chael ar fy siwrnai?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.8" name="A15.8"></a>15.8)&nbsp;Sut ydych chi''n cyfrifo amseroedd siwrnai beicio?  </h3>
...
<br />
<h3><a class="QuestionLink" id="A15.9" name="A15.9"></a>15.9)&nbsp; Pam mae gofyn imi lwytho rheolaethau Active X i lawr?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.10" name="A15.10"></a>15.10)&nbsp;Beth ddylwn ei wneud os gofynnir imi lwytho''r rheolaeth i lawr?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.11" name="A15.11"></a>15.11)&nbsp;Beth ddylwn ei wneud os nad wyf yn gallu gweld y graff ac os na ofynnwyd imi lwytho''r rheolaeth ActiveX i lawr?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.12" name="A15.12"></a>15.12)&nbsp;Beth yw ffeil GPX?</h3>
...
<br />
<h3><a class="QuestionLink" id="A15.13" name="A15.13"></a>15.13)&nbsp;Sut mae Transport Direct yn Cyfrifo Calorïau a ddefnyddir?</h3>
...
<p class="rsviewcontentrow"><a href="#A17.1">17.1) What information do you provide about accessible services, and which areas are covered?</a></p>
<p class="rsviewcontentrow"><a href="#A17.2">17.2) How accurate is your information on accessible journeys?</a></p>
<p class="rsviewcontentrow"><a href="#A17.3">17.3) What do you mean by ''assistance''?</a></p>
<p class="rsviewcontentrow"><a href="#A17.4">17.4) Why do you include journey legs that require assistance in your ''step-free only'' results?</a></p>
<p class="rsviewcontentrow"><a href="#A17.5">17.5) Why do I need to book in advance?</a></p>
<p class="rsviewcontentrow"><a href="#A17.6">17.6) How can I book in advance?</a></p>
<p class="rsviewcontentrow"><a href="#A17.7">17.7) How does the ''Find Nearest Accessible Stop'' work?</a></p>
<p class="rsviewcontentrow"><a href="#A17.8">17.8) How can I get to the nearest accessible station or stop?</a></p>
<p class="rsviewcontentrow"><a href="#A17.9">17.9) Can I choose an accessible journey that only uses particular types of transport?</a></p>
<p class="rsviewcontentrow"><a href="#A17.10">17.10) Can I obtain more information about the accessibility of a station?</a></p>
<p class="rsviewcontentrow"><a href="#A17.11">17.11) Can you provide fares information?</a></p>
<p class="rsviewcontentrow"><a href="#A17.12">17.12) Why didn''t I get any results for my accessible journey?</a></p>
<p class="rsviewcontentrow"><a href="#A17.13">17.13) I don''t believe a service, station or stop included in your journey results is accessible.  Can you correct this?</a></p>
<p class="rsviewcontentrow"><a href="#A17.14">17.14) Can I use my mobility scooter on public transport?</a></p>
<p class="rsviewcontentrow"><a href="#A17.15">17.15) Why can''t I plan to an airport, even though I know it is accessible?</a></p>
<p class="rsviewcontentrow"><a href="#A17.16">17.16) How do I find out about live incidents on the transport network once my journey has started?</a></p>

<div>&nbsp;</div>
<div class="hdtypethree"><h2>17. Accessible Journey Planning</h2></div>
<br />

<h3><a class="QuestionLink" id="A17.1" name="A17.1"></a>17.1) What information do you provide about accessible services, and which areas are covered?</h3>
...
<h3><a class="QuestionLink" id="A17.2" name="A17.2"></a>17.2) How accurate is your information on accessible journeys?</h3>
...
<h3><a class="QuestionLink" id="A17.3" name="A17.3"></a>17.3) What do you mean by ''assistance''?</h3>
...
<h3><a class="QuestionLink" id="A17.4" name="A17.4"></a>17.4) Why do you include journey legs that require assistance in your ''step-free only'' results?</h3>
...
<h3><a class="QuestionLink" id="A17.5" name="A17.5"></a>17.5) Why do I need to book in advance?</h3>
...
<h3><a class="QuestionLink" id="A17.6" name="A17.6"></a>17.6) How can I book in advance?</h3>
...
<h3><a class="QuestionLink" id="A17.7" name="A17.7"></a>17.7) How does the ''Find Nearest Accessible Stop'' work?</h3>
...
<h3><a class="QuestionLink" id="A17.8" name="A17.8"></a>17.8) How can I get to the nearest accessible station or stop?</h3>
...
<h3><a class="QuestionLink" id="A17.9" name="A17.9"></a>17.9) Can I choose an accessible journey that only uses particular types of transport?</h3> 
...
<h3><a class="QuestionLink" id="A17.10" name="A17.10"></a>17.10) Can I obtain more information about the accessibility of a station?</h3>
...
<h3><a class="QuestionLink" id="A17.11" name="A17.11"></a>17.11) Can you provide fares information?</h3>
...
<h3><a class="QuestionLink" id="A17.12" name="A17.12"></a>17.12) Why didn''t I get any results for my accessible journey?</h3>
...
<h3><a class="QuestionLink" id="A17.13" name="A17.13"></a>17.13) I don''t believe a service, station or stop included in your journey results is accessible.  Can you correct this?</h3>
...
<h3><a class="QuestionLink" id="A17.14" name="A17.14"></a>17.14) Can I use my mobility scooter on public transport?</h3>  
...
<h3><a class="QuestionLink" id="A17.15" name="A17.15"></a>17.15) Why can''t I plan to an airport, even though I know it is accessible?</h3>
...
<h3><a class="QuestionLink" id="A17.16" name="A17.16"></a>17.16) How do I find out about live incidents on the transport network once my journey has started?</h3>
...
SET @ScriptNumber = 10405
SET @ScriptDesc = 'Updates to FAQs - BusinessGateway'


DECLARE @VersionInfo VARCHAR(24)
SET @VersionInfo = '$Revision:   1.64  $'
