-- ***********************************************
-- NAME 		: SCP10402_BusinessGateway_2_Properties.sql
-- DESCRIPTION 		: Script to add specific properties for a Theme
-- AUTHOR		: Phil Scott
-- DATE			: 18 Mar 2009 18:00:00
-- ************************************************
...
BEGIN
	insert into properties values ('ToolbarDownloadAvailable', 'False', '<DEFAULT>', '<DEFAULT>', 0, @ThemeId)
END
ELSE
BEGIN
	update properties 
...
BEGIN
	insert into properties values ('LoginRegisterImageButtonAvailable', 'False', '<DEFAULT>', '<DEFAULT>', 0, @ThemeId)
END
ELSE
BEGIN
	update properties 
...
BEGIN
	insert into properties values ('MobileDemonstratorAvailable', 'False', '<DEFAULT>', '<DEFAULT>', 0, @ThemeId)
END
ELSE
BEGIN
	update properties 
...
BEGIN
	insert into properties values ('PoweredByControl.ShowPoweredBy', 'False', '<DEFAULT>', '<DEFAULT>', 0, @ThemeId)
END
ELSE
BEGIN
	update properties 
...
SET @ScriptNumber = 10402
SET @ScriptDesc = 'Properties added for theme BusinessGateway'
