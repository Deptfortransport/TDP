-- ***********************************************
-- NAME 		: SCP10604_DirectGov_4_Content.sql
...
'<div class="MinihomeHyperlinksInfoContent">
  ...
  <div class="MinihomeSoftContent">
    ...
    src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/JourneyMiniHomePageDetail.jpg"
    ...
    src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/JourneyMiniHomePageMap.jpg"
    align="left" border="0" />
    ...
    src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomePlanAJourneyQuickPlanners5.JPG"
    border="0" />
    <p>&#160;</p>
    ...
    src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/findCycleDetails.gif"
    align="left" border="0" />
    <br clear="left" />
    ...
    src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomePlanAJourneyBookmark.JPG"
    border="0" />
    <p>&#160;</p>
    ...
    src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/SocialNetworks.jpg"
...
'<div class="MinihomeHyperlinksInfoContent">
  ...
  <div class="MinihomeSoftContent">
    ...
    align="left" border="0" />
    <br clear="left" />
    <p>Mae’r cynllunydd beicio yn cwmpasu sawl ardal o Brydain Fawr ac rydym yn ychwanegu mwy o ardaloedd yn gyson.  Ewch i’n hadran <a href="/Web2/Help/HelpCycle.aspx#A16.2">COA</a> i weld a yw’r cynllunydd beicio yn cynnwys eich ardal chi.
</p>
...
<div class="MinihomeSoftContent">  
<h3>Find me a map...</h3><br/><br/>  
<p>You can <a href="/Web2/Maps/FindMapInput.aspx">find a map</a> of a place, city, attraction, station, stop, address or postcode. </p>  <p>&nbsp;</p><img style="PADDING-LEFT: 10px" alt="Image of a map showing a specific location" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceLocationMap1.JPG" align="right" border="0"/>   <p>You can view the local transport stops and stations in the area and local amenities such as hotels, attractions and public facilities.</p><br clear="right" />
<p>&nbsp;</p>  
<h3>Now plan me a journey there...</h3>  
<p>&nbsp;</p>  
<p><img style="PADDING-RIGHT: 70px; PADDING-LEFT: 10px" alt="Screenshot of a Transport Direct map and the buttons from which to plan a journey" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceMapPlan1.JPG" align="right" border="0"/>
...
src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceNearestMap1.JPG" align="left" border="0"/>
...or you can view them on a map.</p><br clear="left" />
<p>&nbsp;</p>  
<h3>Now plan me a journey there...</h3>  
<p>&nbsp;</p>  
<p><img style="PADDING-LEFT: 10px" alt="Screenshot of the results from the Find nearest station/airport feature on Transport Direct" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceStationJourneyResults.JPG" align="right" border="0"/>The closest station/airport is already selected. Once you have selected the station/airport required, click Travel from or Travel to. Then repeat for the other journey leg and click next.<br/><br/>You will then be able to ''Find journeys between stations/airports'' from the selection you have made.<br/><br/>You may not always get journeys to or from all of your selected stations but the results returned will be the best journeys available between the chosen origin(s) and destination(s).</p><br clear="right" />
<p>&nbsp;</p>  
<h3>Where''s the nearest car park?</h3>  
<p>&nbsp;</p>  
<p>Similarly, you may wish to <a href="/Web2/JourneyPlanning/FindCarParkInput.aspx">find the nearest car parks</a> to a location.</p><br/><img alt="Screenshot of the output from the Find nearest car park feature on Transport Direct" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceCarParkResults.JPG" align="right" border="0"/>   <p>You can view them as a list, in order of their distance from your location, the total number of spaces, and if they have disabled spaces...</p><br clear="right" />  
<p>&nbsp;</p>  
<p><img style="PADDING-RIGHT: 10px" alt="Image of map showing available car parks" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceCarParkMap.JPG" align="left" border="0"/>...or you can view them on a map.</p><br clear="left" />  
<p>&nbsp;</p>  
<h3>Now plan me a journey there...</h3>  
<p>&nbsp;</p>  
<p><img style="PADDING-LEFT: 10px" alt="Screenshot of the output from the Find nearest car park feature on Transport Direct" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceCarParkJourneyResults.JPG" align="right" border="0"/>The closest car park is already selected. Once you have selected the option required, click Drive from or Drive to.<br/><br/>You will then be able to ''Plan a car route'' from/to the car park selected.</p><br clear="right" /> 
<p>&nbsp;</p>  <h3>What will the roads be like?</h3>  <p>&nbsp;</p>  <p>If you are planning to visit a place, you may want to know what the traffic will be like when you travel there.</p><br/>  
<p><img style="PADDING-LEFT: 10px" alt="Image of a map showing predicted traffic levels using different colours to represent estimated congestion" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceTrafficMap1.JPG" align="right" border="0"/>Our <a href="/Web2/Maps/TrafficMaps.aspx">traffic maps</a> are based on recorded traffic levels over the last few years and display an accurate prediction of the likely traffic levels at your precise time of travel.</p><br/>  

<p>&nbsp;</p>  
<h3>I need a tube map...</h3>  
<p>&nbsp;</p>  
<p>Finally, you may just need a map showing part of the rail network, bus routes or a map of the London Underground. Our <a href="/Web2/Maps/NetworkMaps.aspx">transport network maps</a> page links you to a range of sites containing these maps. </p></div></div>',

'<div class="MinihomeHyperlinksInfoContent">  <div class="MinihomeHyperlinksInfoHeader">  <div class="txtsevenbbl"><h2>Dywedwch fwy wrthyf...</h2></div><!-- Following spaces help formatting in 2 ways: 1. Give outer div real content to give height; 2. Add a padding to ensure nice wrapping when ramping up text size -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>  <div class="MinihomeSoftContent">  
<h3>Darganfyddwch fap i mi...</h3><br/><br/>  
<p>Gallwch <a href="/Web2/Maps/FindMapInput.aspx">ddarganfyddwch map</a> o le, dinas, atyniad, gorsaf, arhosfan, cyfeiriad neu god post. </p>  
<p>&nbsp;</p>
<img style="PADDING-LEFT: 10px" alt="Delwedd o fap yn dangos lleoliad penodol" 
src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceLocationMap.JPG" align="right" border="0"/>   
<p>Gallwch weld yr arosfannau a''r gorsafoedd cludiant lleol yn yr ardal a mwynderau lleol fel gwestai, atyniadau a chyfleusterau cyhoeddus.</p><br clear="right" />  
<p>&nbsp;</p>
<h3>Yn awr cynlluniwch siwrnai i mi yno...</h3>
<p>&nbsp;</p>
<p><img style="PADDING-RIGHT: 70px; PADDING-LEFT: 10px" alt=
"Delwedd sgrîn o fap Transport Direct a''r botymau y bwriadwch gynllunio siwrneion ohonynt" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceMapPlan.JPG" align="right" border="0"/>Yna gallwch ddewis cynllunio siwrnai i neu o''r lleoliad a ddangosir ar y map.</p><br clear="right" />
 <p>&nbsp;</p>
<h3>Ble mae''r cludiant agosaf?</h3>  
<p>&nbsp;</p>  
<p>Neu efallai y dymunwch <a href="/Web2/JourneyPlanning/FindAStationInput.aspx">dod o hyd i''r gorsafoedd a''r meysydd awyr agosaf</a> at leoliad.</p><br/><img alt="Delwedd sgrîn o''r allbwn o''r nodwedd Dod ohyd i''r orsaf/maes awyr agosaf ar Transport Direct" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceNearest.JPG" align="right" border="0"/>   <p>Gallwch edrych arnynt fel rhestr, yn nhrefn eu pellter o''ch lleoliad...</p><br clear="right"/>  <p>&nbsp;</p>  <p><img style="PADDING-RIGHT: 10px" alt="Delwedd o fap yn dangos lleoliadau wedi eu rhifo" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceNearestMap.JPG" align="left" border="0"/>
...neu gallwch eu gweld ar fap.</p><br clear="left" />
<p>&nbsp;
</p>  <h3>Yn awr cynlluniwch siwrnai i mi yno...</h3>  
<p>&nbsp;</p>  
...
<p>&nbsp;</p>  <p>Yn yr un modd, mae''n bosibl y byddwch yn dymuno <a href="/Web2/JourneyPlanning/FindCarParkInput.aspx">darganfod y meysydd parcio agosaf</a> i leoliad.</p><br/>
<img alt="Llun sgrîn o''r allbwn o''r nodwedd Darganfyddwch y maes parcio agosaf ar Transport Direct" src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceCarParkResults.JPG" align="right" border="0"/>   
<p>Gallwch eu gweld fel rhestr, yn nhrefn eu pellter o''ch lleoliad chi…</p><br clear="right" />
<p>&nbsp;</p>  
<p><img style="PADDING-RIGHT: 10px" alt="Delwedd o fap yn dangos y meysydd parcio sydd ar gael" 
src="/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceCarParkMap.JPG" align="left" border="0"/>
...neu gallwch eu gweld ar fap.</p><br clear="left" /> 
<p>&nbsp;</p>  
<h3>Yn awr cynlluniwch siwrnai i mi yno...</h3>  
<p>&nbsp;</p>  
...
"/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceCarParkJourneyResults.JPG" 
...
alt="Delwedd o fap yn dangos y lefelau traffig a ragfynegir gan ddefnyddio lliwiau gwahanol i gynrychioli amcangyfrif o''r tagfeydd" src=
"/Web2/App_Themes/DirectGov/images/gifs/SoftContent/HomeFindAPlaceTrafficMap.JPG" 
align="right" border="0"/>Seilir ein <a href="/Web2/Maps/TrafficMaps.aspx">mapiau traffig</a> ar lefelau traffig a gofnodwyd dros 
yr ychydig flynyddoedd diwethaf ac maent yn dangos rhagfynegiad cywir o''r lefelau traffig tebygol ar yr union adeg y byddwch 
yn teithio.</p><br clear="right" />  
<p>&nbsp;</p>  
...
<br/><br/>
Discover the <a href="http://www.direct.gov.uk/en/DisabledPeople/MotoringAndTransport/Bluebadgescheme/DG_10038295" >Blue Badge map here</a>
...
'
<div class="smcSiteMapLink"><a href="http://www.direct.gov.uk/en/Hl1/Help/YourQuestions/DG_069492">Gwybodaeth teithio ar eich ffôn symudol</a><br/></div>
