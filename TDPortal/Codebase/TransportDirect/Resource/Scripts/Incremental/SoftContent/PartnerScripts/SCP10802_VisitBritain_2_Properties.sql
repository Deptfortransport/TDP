-- ***********************************************
-- NAME 		: SCP10802_VisitBritain_2_Properties.sql
-- DESCRIPTION 		: Script to add specific properties for a Theme - VisitBritain
-- AUTHOR		: Mitesh Modi
...
BEGIN
	insert into properties values ('LinkToWebsiteAvailable', 'False', '<DEFAULT>', '<DEFAULT>', 0, @ThemeId)
END
ELSE
BEGIN
	update properties 
...
SET @ScriptNumber = 10802
SET @ScriptDesc = 'Properties added for theme VisitBritain'
