...
EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'PrintableHeaderControl.transportDirectLogoImg.AlternateText', 'Visit Britain', 'Visit Britain'
...
<tr>
<td class="TipsToolsIconPadding"><a href="/Web2/TDOnTheMove/TDOnTheMove.aspx"><img title="Services available on your mobile" height="30" alt="Services available on your mobile" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/en/phone.gif" width="30"/></a></td>
<td><a href="/Web2/TDOnTheMove/TDOnTheMove.aspx">Get live departures on your mobile</a></td></tr>
</tbody></table></div>'
, 
'<div class="Column2Header">
...
<tr>
<td class="TipsToolsIconPadding"><a href="/Web2/TDOnTheMove/TDOnTheMove.aspx"><img title="Gwasanaethau sydd ar gael ar eich ff&#244;n symudol" height="30" alt="Gwasanaethau sydd ar gael ar eich ff&#244;n symudol" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/en/phone.gif" width="30"/></a></td>
<td><a href="/Web2/TDOnTheMove/TDOnTheMove.aspx">Derbyniwch ymadawiadau byw ar eich ff&#244;n symudol</a></td></tr>
</tbody></table></div>'
...
'<div class="MinihomeHyperlinksInfoContent">
  ...
  <div class="MinihomeSoftContent">
    ...
    src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/JourneyMiniHomePageDetail.jpg"
    ...
    src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/JourneyMiniHomePageMap.jpg"
    align="left" border="0" />
    ...
    src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomePlanAJourneyQuickPlanners5.JPG"
    border="0" />
    <p>&#160;</p>
    ...
    src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/findCycleDetails.gif"
    align="left" border="0" />
    <br clear="left" />
    ...
    src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomePlanAJourneyBookmark.JPG"
    border="0" />
    <p>&#160;</p>
    ...
    src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/SocialNetworks.jpg"
...
'<div class="MinihomeHyperlinksInfoContent">
  ...
  <div class="MinihomeSoftContent">
    ...
    src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/JourneyMiniHomePageMap.jpg"
    align="left" border="0" />
    Drwy glicio ar y botwm ‘Mapiau’ neu ‘Dangos map’ gallwch weld map o’ch siwrnai gyfan, neu gallwch edrych ar ddarnau unigol ohoni drwy glicio ar fotwm y map ger y darn hwnnw.</p>
    <br clear="left" />
    <br />
...
<p>&nbsp;</p><img style="PADDING-LEFT: 10px" alt="Image of a map showing a specific location" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceLocationMap1.JPG" align="right" border="0"/>   
<p>You can view the local transport stops and stations in the area and local amenities such as hotels, attractions and public facilities.</p><br clear="right" />

<p>&nbsp;</p>

<h3>Now plan me a journey there...</h3> 
<p>&nbsp;</p>  
<p><img style="PADDING-RIGHT: 70px; PADDING-LEFT: 10px" alt="Screenshot of a Transport Direct map and the buttons from which to plan a journey" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceMapPlan1.JPG" align="right" border="0"/>
You can then choose to plan a journey to or from the location shown on the map.</p><br clear="right" />
<p>&nbsp;</p>  
...
airports</a> to a location.</p><br clear="right" />
<img alt=
"Screenshot of the output from the Find nearest station/airport feature on Transport Direct" 
src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceNearest1.JPG" 
align="right" border="0"/>   
<p>You can view them as a list, in order of their distance from your location...</p><br clear="right" />  
<p>&nbsp;</p>  
<p><img style="PADDING-RIGHT: 10px" alt="Image of map showing numbered locations" 
src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceNearestMap1.JPG" align="left" border="0"/>
...or you can view them on a map.</p><br clear="left" />
<p>&nbsp;</p>  
<h3>Now plan me a journey there...</h3>  
<p>&nbsp;</p>  
<p><img style="PADDING-LEFT: 10px" 
alt="Screenshot of the results from the Find nearest station/airport feature on Transport Direct" 
src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceStationJourneyResults.JPG" 
...
<br/>
You will then be able to ''Find journeys between stations/airports'' from the selection you have made.<br/>
You may not always get journeys to or from all of your selected stations but the results 
returned will be the best journeys available between the chosen origin(s) and destination(s).</p><br clear="right" />
<p>&nbsp;</p>  
<h3>Where''s the nearest car park?</h3>  
<p>&nbsp;</p>  <p>Similarly, you may wish to <a href="/Web2/JourneyPlanning/FindCarParkInput.aspx">find the nearest car parks</a> to a location.</p><br/><img alt="Screenshot of the output from the Find nearest car park feature on Transport Direct" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceCarParkResults.JPG" align="right" border="0"/>   
<p>You can view them as a list, in order of their distance from your location, the total number of spaces, and if they have disabled spaces...</p><br clear="right"/>
<p>&nbsp;</p>  
<p><img style="PADDING-RIGHT: 10px" alt="Image of map showing available car parks" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceCarParkMap.JPG" 
align="left" border="0"/>...or you can view them on a map.</p><br clear="left" />  
<p>&nbsp;</p>  
<h3>Now plan me a journey there...</h3>  <p>&nbsp;</p>  
<p><img style="PADDING-LEFT: 10px" alt="Screenshot of the output from the Find nearest car park feature on Transport Direct" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceCarParkJourneyResults.JPG" align="right" border="0"/>The closest car park is already selected. Once you have selected the option required, click Drive from or Drive to.<br/><br/>You will then be able to ''Plan a car route'' from/to the car park selected.</p><br clear="right" /> 
<p>&nbsp;</p>  
<h3>What will the roads be like?</h3>  <p>&nbsp;</p>  
<p>If you are planning to visit a place, you may want to know what the traffic will be like when you travel there.</p><br/>  
<p><img style="PADDING-LEFT: 10px" alt="Image of a map showing predicted traffic levels using different colours to represent estimated congestion" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceTrafficMap1.JPG" align="right" border="0"/>Our <a href="/Web2/Maps/TrafficMaps.aspx">traffic maps</a> are based on recorded traffic levels over the last few years and display an accurate prediction of the likely traffic levels at your precise time of travel.</p><br/>  <p>&nbsp;</p>  <h3>I need a tube map...</h3>  <p>&nbsp;</p>  <p>Finally, you may just need a map showing part of the rail network, bus routes or a map of the London Underground. Our <a href="/Web2/Maps/NetworkMaps.aspx">transport network maps</a> page links you to a range of sites containing these maps. </p></div></div>',
'<div class="MinihomeHyperlinksInfoContent">  <div class="MinihomeHyperlinksInfoHeader">  <div class="txtsevenbbl"><h2>Dywedwch fwy wrthyf...</h2></div><!-- Following spaces help formatting in 2 ways: 1. Give outer div real content to give height; 2. Add a padding to ensure nice wrapping when ramping up text size -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>  <div class="MinihomeSoftContent">  <h3>Darganfyddwch fap i mi...</h3><br/><br/>  <p>Gallwch <a href="/Web2/Maps/FindMapInput.aspx">ddarganfyddwch map</a> o le, dinas, atyniad, gorsaf, arhosfan, cyfeiriad neu god post. </p>  <p>&nbsp;</p><img style="PADDING-LEFT: 10px" alt="Delwedd o fap yn dangos lleoliad penodol" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceLocationMap.JPG" align="right" border="0"/>   <p>Gallwch weld yr arosfannau a''r gorsafoedd cludiant lleol yn yr ardal a mwynderau lleol fel gwestai, atyniadau a chyfleusterau cyhoeddus.</p><br clear="right" />
<p>&nbsp;</p>  
<h3>Yn awr cynlluniwch siwrnai i mi yno...</h3>  
<p>&nbsp;</p>  
<p><img style="PADDING-RIGHT: 70px; PADDING-LEFT: 10px" alt=
"Delwedd sgrîn o fap Transport Direct a''r botymau y bwriadwch gynllunio siwrneion ohonynt" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceMapPlan.JPG" align="right" border="0"/>Yna gallwch ddewis cynllunio siwrnai i neu o''r lleoliad a ddangosir ar y map.</p><br clear="right" />
<p>&nbsp;</p>  
...
<img alt="Delwedd sgrîn o''r allbwn o''r nodwedd Dod ohyd i''r orsaf/maes awyr agosaf ar Transport Direct" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceNearest.JPG" align="right" border="0"/>   
<p>Gallwch edrych arnynt fel rhestr, yn nhrefn eu pellter o''ch lleoliad...</p><br clear="right" />   
<p>&nbsp;</p>  
<p><img style="PADDING-RIGHT: 10px" alt="Delwedd o fap yn dangos lleoliadau wedi eu rhifo" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceNearestMap.JPG" align="left" border="0"/>
...neu gallwch eu gweld ar fap.</p><br clear="left" /> 
<p>&nbsp;</p>  
<h3>Yn awr cynlluniwch siwrnai i mi yno...</h3>  <p>&nbsp;</p>  
<p><img style="PADDING-LEFT: 10px" alt="Llun sgrîn o''r allbwn o''r nodwedd Dod o hyd i''r orsaf/maes awyr agosaf ar Transport Direct" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceStationJourneyResults.JPG" align="right" border="0"/>Mae''r orsaf/maes awyr agosaf wedi ei dicio yn barod. Wedi i chi ddewis yr opsiwn/opsiynau angenrheidiol, cliciwch ar Teithio o neu Teithio i. Yna ailadroddwch hyn ar gyfer yr adran arall o''r siwrnai a chliciwch nesaf.<br/><br/>Yna byddwch yn gallu ''Darganfyddwch siwrneion rhwng gorsafoedd/meysydd awyr'' o''r dewis yr ydych wedi ei wneud.<br/><br/>Efallai na fydd wastad yn bosibl i chi gael siwrneion sy''n gadael neu''n cyrraedd pob gorsaf a ddewiswyd gennych ond byddwn yn dychwelyd manylion y siwrneion gorau sydd ar gael rhwng y man(nau) cychwyn a''r cyrchfan(nau) a ddewiswyd.</p><br/>  
<p>&nbsp;</p>  
<h3>Ble mae''r maes parcio agosaf?</h3>  
<p>&nbsp;</p>  <p>Yn yr un modd, mae''n bosibl y byddwch yn dymuno <a href="/Web2/JourneyPlanning/FindCarParkInput.aspx">darganfod y meysydd parcio agosaf</a> i leoliad.</p><br/><img alt="Llun sgrîn o''r allbwn o''r nodwedd Darganfyddwch y maes parcio agosaf ar Transport Direct" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceCarParkResults.JPG" align="right" border="0"/>   
...
"/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceCarParkMap.JPG" 
align="left" border="0"/>...neu gallwch eu gweld ar fap.</p><br clear="left" />
<p>&nbsp;</p>  
<h3>Yn awr cynlluniwch siwrnai i mi yno...</h3>  
<p>&nbsp;</p>  
<p><img style="PADDING-LEFT: 10px" alt=
"Llun sgrîn o''r allbwn o''r nodwedd Darganfyddwch y maes parcio agosaf ar Transport Direct" src=
"/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceCarParkJourneyResults.JPG" 
...
deithiwch yno.</p><br/>  
<p><img style="PADDING-LEFT: 10px" alt=
"Delwedd o fap yn dangos y lefelau traffig a ragfynegir gan ddefnyddio lliwiau gwahanol i gynrychioli amcangyfrif o''r tagfeydd" src=
"/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeFindAPlaceTrafficMap.JPG" 
...
<p>&nbsp;</p>  
<p>Yn olaf, efallai y bydd arnoch angen map yn dangos rhan o rwydwaith y rheilffordd, y llwybrau bysiau neu fap o drenau tanddaearol Llundain. Mae ein tudalen <a href="/Web2/Maps/NetworkMaps.aspx">mapiau''r rhwydwaith cludiant</a> yn eich cysylltu ag ystod o safleoedd yn cynnwys y mapiau hyn. </p></div></div>'
...
'<div class="MinihomeHyperlinksInfoContent">  <div class="MinihomeHyperlinksInfoHeader">  <div class="txtsevenbbl"><h2>Helping you get the most from Transport Direct</h2></div><!-- Following spaces help   formatting in 2 ways: 1. Give outer div real content to give height; 2. Add a padding to ensure nice   wrapping when ramping up text size -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>  <div class="MinihomeSoftContent" summary="Tips and tools content">  <h3>Compare CO2 emissions for your journey... </h3>  <p>&nbsp;</p>  <p>You can now compare the CO2 emissions of the four main modes of transport (Car, Rail, Bus/coach, and Plane) for your journey.</p><br/><img alt="Screen shot of CO2 Emissions page" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeTipsToolsEmissions2.jpg" align="right" border="0"/>   <p>You can do a simple emissions comparison by inputting a distance in miles or kilometres. TD will tell you how much CO2 would be emitted if you travelled that distance by car, train, bus, or plane.</p><br/>  <p>&nbsp;</p>  <p><img alt="Screen shot of CO2 Emissions for your journey" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeTipsToolsEmissionsJourney2.jpg" align="left" border="0"/>Or look at the emissions for your journey by different modes of transport by following the links from your journey details page.</p><br/>  <p>&nbsp;</p>  <p>Go to the <a href="/Web2/JourneyPlanning/JourneyEmissionsCompare.aspx">CO2 emissions</a> page to find out.</p>  <p>&nbsp;</p>  <h3>Getting Transport Direct on the move...</h3>  <p>&nbsp;</p>  <p>You can also get our Transport Direct Mobile service on your mobile phone or PDA for free. </p><br/><img style="PADDING-RIGHT: 10px" alt="Screenshot of mobile simulator showing a real-time &#13;&#10;departures board" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeTipsToolsMobile.jpg" align="left" border="0"/>   <p>You can search for next train departures and arrivals, check whether a train is running on time and look up times for tomorrow. </p><br/>  <p>You can check scheduled bus times (for most of Britain). </p><br/>  <p>You can also check if there are any current or planned disruptions for both road and public transport. </p><br/>  <p>Visit mobile.transportdirect.info on your phone or PDA or use our <a href="/Web2/TDOnTheMove/TDOnTheMove.aspx">mobile simulator </a>to see how the service works and to send a link free-of-charge to your phone or PDA. </p><br/>  <p>&nbsp;</p> <h3>I use a screen-reader...</h3>  <p>&nbsp;</p>  <p>We aim to provide an equivalent experience for screen-reader users as well as users who do not need this technology. In order for you to best understand how the site works and how to get the most out of the journey planning features, visit the <a href="/Web2/About/Accessibility.aspx">Accessibility</a> section. </p></div></div>', 
'<div class="MinihomeHyperlinksInfoContent">  <div class="MinihomeHyperlinksInfoHeader">  <div class="txtsevenbbl"><h2>Dywedwch fwy wrthyf...</h2><!-- New heading text should read "Helping you get the most from Transport Direct" replacing "Tell me more" --></div><!-- Following spaces help formatting in 2 ways: 1. Give outer div real content to give height; 2. Add a padding to ensure nice wrapping when ramping up text size -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>  <div class="MinihomeSoftContent" summary="Tips and tools content">  <h3>Cymharwch allyriadau CO2 ar gyfer eich siwrnai... </h3>  <p>&nbsp;</p>  <p>Nawr fe allwch gymharu allyriadau CO2 y pedwar prif fath o drafnidiaeth (Car, Tr&#234;n, Bws/coets, ac Awyren) ar gyfer eich siwrnai.</p><br/>&nbsp;   <p><img alt="Llun sgrin o dudalen Allyriadau CO2" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeTipsToolsEmissions2.jpg" align="right" border="0"/>Gallwch gymharu allyriadau yn syml drwy nodi pellter mewn milltiroedd neu gilometrau. Bydd Transport Direct yn dweud wrthych faint o CO2 fyddai''n cael ei ollwng pe byddech chi''n teithio''r pellter hwnnw mewn car, tr&#234;n, bws, neu awyren.</p><br/>  <p>&nbsp;</p>  <p><img alt="Llun sgrin o Allyriadau CO2 ar gyfer eich siwrnai" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeTipsToolsEmissionsJourney2.jpg" align="left" border="0"/>Neu edrychwch ar yr allyriadau ar gyfer eich siwrnai yn &#244;l gwahanol fathau o drafnidiaeth drwy ddilyn y cysylltau o dudalen manylion eich siwrnai.</p><br/>  <p>&nbsp;</p>  <p>Ewch i''r dudalen <a href="/Web2/JourneyPlanning/JourneyEmissionsCompare.aspx">allyriadau CO2</a> i gael gwybod.</p>  <p>&nbsp;</p>  <h3>Cael Transport Direct i symud...</h3>  <p>&nbsp;</p>  <p>Gallwch hefyd gael ein gwasanaeth Transport Direct Symudol ar eich ff&#244;n symudol neu PDA am ddim. </p><br/><img style="PADDING-RIGHT: 10px" alt="Delwedd sgr&#238;n o ysgogydd symudol yn dangos bwrdd ymadawiadau mewn amser real" src="/Web2/App_Themes/VisitBritain/images/gifs/SoftContent/HomeTipsToolsMobile1.jpg" align="left" border="0"/>   <p>Gallwch chwilio am yr amserau y mae&#8217;r tr&#234;n nesaf yn ymadael ac yn cyrraedd, gweld a yw tr&#234;n yn rhedeg mewn pryd a chwilio am yr amserau ar gyfer yfory. </p><br/>  <p>Gallwch edrych ar amserau bysiau rhestredig (ar gyfer y rhan fwyaf o Brydain). </p><br/>  <p>Gallwch hefyd weld a oes unrhyw achosion o darfu ar gludiant y ffyrdd a chludiant cyhoeddus ar hyn o bryd neu rai wedi eu cynllunio. </p><br/>  <p>Ymwelwch &#226; mobile.transportdirect.info ar eich ff&#244;n neu PDA neu defnyddiwch ein <a href="/Web2/TDOnTheMove/TDOnTheMove.aspx">ysgogydd efelchydd</a> i weld sut mae&#8217;r gwasanaeth yn gweithio ac i anfon dolen am ddim i&#8217;ch ff&#244;n neu PDA. </p><br/>  <p>&nbsp;</p> <h3>Rwy&#8217;n defnyddio darllenwr sgr&#238;n...</h3>  <p>&nbsp;</p>  <p>Anelwn at ddarparu profiad cyfwerth ar gyfer defnyddwyr darllenwyr sgr&#238;n yn ogystal &#226; defnyddwyr nad oes arnynt angen y dechnoleg hon. Er mwyn i chi ddeall orau sut mae''r safle yn gweithio a sut i gael y gorau o''r nodweddion cynllunio siwrnai, ymwelwch &#226;"r adran <a href="/TransportDirect/cy/About/Accessibility.aspx">Hygyrchedd</a> yn y tudalennau Amdanom ni. </p></div></div>'
...
-- Second Third items
EXEC AddtblContent
@ThemeId, 15, 'TDAdditionalInformationHtmlPlaceholderDefinition', '/Channels/TransportDirect/Home', 
'<div class="Column3Header">
<div class="txtsevenbbl">Britain</div>
...
Britain is full of contrasts; whichever direction you travel you will
find a wide variety of landscapes and diverse cultures to explore.
England, Wales, Scotland and Northern Ireland are all unique countries
with their own customs, cultures and traditions.
<br />
<a href="http://www.visitbritain.com/en/destinations/" >Click here to see our destinations.</a>
</td></tr></tbody></table></div>
<div class="Column3Header">
<div class="txtsevenbbl">Things to see &amp; do</div>
<div class="clearboth" ></div>
</div>
<div class="Column3Content">
...
<tr>
<td class="txtseven" valign="top">
Unique, traditional, cutting edge, refreshing, imaginative, surprising -
Britain is all this and much much more. Whether you''re looking for
inspiration, action, relaxation or want to discover Britain''s hidden
treasures, explore Britain your own way...
<br />
<a href="http://www.visitbritain.com/en/things-to-see-and-do/" >Click here and take a look at things to see and do.</a>
</td></tr></tbody></table></div>', 
...
'<div class="Column3Header">
<div class="txtsevenbbl">Accommodation</div>
<div class="clearboth" ></div>
</div>
<div class="Column3Content">
...
<tr>
<td class="txtseven">
Whatever your destination or budget there''s a limitless range of quality
accommodation to choose from in Britain. We have over 37,000 places to
stay in our accommodation directory - Britain''s largest listing! So
whether you''re looking for a luxury metro hotel, a farmhouse B&amp;B or a
simple low-cost hostel, let us help you find the perfect place for your
stay in Britain. 
<br />
<a href="http://www.visitbritain.com/en/accommodation/" >Click here to see a range of accommodation.</a>
</td></tr></tbody></table></div>', 
...
<div class="smcSiteMapLink"><a href="/Web2/Tools/Home.aspx#digitvinfo">Digital TV</a><br/></div>
', 
...
EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonAmendCarDetailsTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendCarDetailsTabSelected.gif', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendCarDetailsTabSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonAmendCarDetailsTabUnselected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendCarDetailsTabUnselected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendCarDetailsTabUnselected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonAmendDayTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendDateTabSelected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendDateTabSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonAmendDayTabUnselected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendDateTabUnselected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendDateTabUnselected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonAmendTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendTabSelected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendTabSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonAmendTabUnselected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendTabUnselected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendTabUnselected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonAmendViewTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendViewTabSelected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendViewTabSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonAmendViewTabUnSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendViewTabUnSelected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendViewTabUnSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonCostSearchDateTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendDateTabSelected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendDateTabSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonCostSearchDateTabUnselected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendDateTabUnselected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendDateTabUnselected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonFareTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendFareDetailsTabSelected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendFareDetailsTabSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonFareTabUnselected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendFareDetailsTabUnselected.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendFareDetailsTabUnselected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonStopoverTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendStopoverBlue.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendStopoverBlue.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonStopoverTabUnselected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/AmendStopoverGrey.gif','/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/AmendStopoverGrey.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonSaveTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/SaveTabSelected.gif', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/SaveTabSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonSaveTabUnselected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/SaveTabUnselected.gif', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/SaveTabUnselected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonSendTabSelected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/SendTabSelected.gif', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/SendTabSelected.gif'

EXEC AddtblContent
@ThemeId, 1, 'langStrings', 'AmendSaveSend.ImageButtonSendTabUnselected', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/en/SendTabUnselected.gif', '/Web2/App_Themes/VisitBritain/images/gifs/JourneyPlanning/cy/SendTabUnselected.gif'
...
Exec AddtblContent
@ThemeId, 1, 'langstrings', 'panelMapLocationSelect.labelMapSymbolsDisclaimer',
'Accommodation, attractions and other business featured may not have been assessed or approved by VisitBritain or 
its tourism partners.',
'cy Accommodation, attractions and other business featured may not have been assessed or approved by VisitBritain or 
its tourism partners.'
