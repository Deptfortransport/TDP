-- ***********************************************
-- NAME 		: SCP10603_DirectGov_3_Left_hand_links.sql
-- DESCRIPTION 	: Script to add all the left hand links for a Theme - DirectGov
-- AUTHOR		: Mitesh Modi
-- DATE			: 26 Mar 2008
-- ************************************************
...
-- BEGIN Set up the suggestion links to use
DECLARE
...
SET @StringExternalLinkID = 'ThemeDirectGov_MobileDemonstrator'
SET @StringLinkURL = 'http://www.direct.gov.uk/en/Hl1/Help/YourQuestions/DG_069492'
SET @StringTestURL = 'http://www.direct.gov.uk/en/Hl1/Help/YourQuestions/DG_069492'
SET @StringLinkDescription = 'Partner specific url for MobileDemonstrator'
...
SET @StringLinkResourceName = 'MobileDemonstrator' -- Reuse existing resource for link
SET @LinkCategoryName = 'General'
SET @LinkPriority = 185
SET @IsRoot = 1
SET @IsSubRootLink = 0
SET @SubRootLinkId = 0
	-- Add the 'General' category suggestion link
...
SET @LinkPriority = 5035
SET @IsRoot = 0
SET @IsSubRootLink = 0
SET @SubRootLinkId = 0
	-- Add the 'Tips and tools' category suggestion link
	EXEC AddSuggestionLink @StringLinkResourceName, @StringLinkDescription, @LinkCategoryName, @LinkPriority, 
				@InternalLinkFlag, @IsRoot, @IsSubRootLink, @SubRootLinkId, @StringExternalLinkID

SET @LinkCategoryName = 'Related links'
SET @LinkPriority = 1365
SET @IsRoot = 0
SET @IsSubRootLink = 0
SET @SubRootLinkId = 0
	-- Add the 'Related links' category suggestion link
	EXEC AddSuggestionLink @StringLinkResourceName, @StringLinkDescription, @LinkCategoryName, @LinkPriority, 
				@InternalLinkFlag, @IsRoot, @IsSubRootLink, @SubRootLinkId, @StringExternalLinkID
-- END Set up the suggestion links to use

-- BEGIN Add links to the ContextSuggestion link table for the Theme
DECLARE	@ThemeId int
SET @ThemeId = 5

EXEC AddContextSuggestionLink @StringLinkResourceName,'Tips and tools','FindTrainCostInput', @ThemeId
EXEC AddContextSuggestionLink @StringLinkResourceName,'Tips and tools','FindTrainInput', @ThemeId
EXEC AddContextSuggestionLink @StringLinkResourceName,'Tips and tools','HomePageMenu', @ThemeId
EXEC AddContextSuggestionLink @StringLinkResourceName,'Tips and tools','HomePageMenuTipsAndTools', @ThemeId
EXEC AddContextSuggestionLink @StringLinkResourceName,'General','HomePlanAJourney', @ThemeId
EXEC AddContextSuggestionLink @StringLinkResourceName,'Related links','RelatedLinksContextFindTrainCostInput', @ThemeId
EXEC AddContextSuggestionLink @StringLinkResourceName,'Related links','RelatedLinksContextFindTrainInput', @ThemeId
EXEC AddContextSuggestionLink @StringLinkResourceName,'Related links','RelatedLinksContextHomeJourneyPlanning', @ThemeId
-- END Add links to the ContextSuggestion link table for the Theme
...
SET @ScriptNumber = 10603
SET @ScriptDesc = 'Added left hand links for theme DirectGov update'


DECLARE @VersionInfo VARCHAR(24)
SET @VersionInfo = '$Revision:   1.10  $'
