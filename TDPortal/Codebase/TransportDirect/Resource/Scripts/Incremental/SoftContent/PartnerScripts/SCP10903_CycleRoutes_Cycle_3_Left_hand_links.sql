-- ***********************************************
-- NAME 		: SCP10903_CycleRoutes_Cycle_3_Left_hand_links.sql
-- DESCRIPTION 	: Script to add all the left hand links for CycleRoutes Cycle Only partner theme
-- AUTHOR		: Amit Patel
-- DATE			: 20 Dec 2008
-- ************************************************
...
SET @ScriptNumber = 10903
SET @ScriptDesc = 'Script to add all the left hand links for CycleRoutes Cycle Only partner theme'
