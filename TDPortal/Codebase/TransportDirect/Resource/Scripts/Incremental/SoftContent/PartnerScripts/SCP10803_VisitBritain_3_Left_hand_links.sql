-- ***********************************************
-- NAME 		: SCP10803_VisitBritain_3_Left_hand_links.sql
-- DESCRIPTION 		: Script to add all the left hand links for a Theme - VistiBritain
-- AUTHOR		: Mitesh Modi
-- DATE			: 26 Mar 2008
-- ************************************************
...
--'LinksToOurWebsite'
--'ToolbarDownload'
--'ProvideFeedback.TourismInformation'
...
SET @ScriptNumber = 10803
SET @ScriptDesc = 'Added left hand links for theme VisitBritain update'
