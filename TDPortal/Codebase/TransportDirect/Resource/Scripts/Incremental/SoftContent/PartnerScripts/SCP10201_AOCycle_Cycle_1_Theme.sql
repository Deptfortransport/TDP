-- ***********************************************
-- NAME 		: SCP10201_AOCycle_Cycle_1_Theme.sql
-- DESCRIPTION 	: Script to add a new Theme for a Partner - AOCycle
-- AUTHOR		: Amit Patel
-- DATE			: 29 Mar 2010
-- ************************************************
...
SET @ThemeId = 200
SET @ThemeName = 'AOCycle'
-- set the most common domains
SET @Domain1 = 'AOCycle'
SET @Domain2 = 'AOCycle.transportdirect.info'
SET @Domain3 = 'AOCycle.sitest.transportdirect.info'
SET @Domain4 = 'AOCycle.test.transportdirect.info'
...
SET @ScriptNumber = 10201
SET @ScriptDesc = 'New theme added for AOCycle'
