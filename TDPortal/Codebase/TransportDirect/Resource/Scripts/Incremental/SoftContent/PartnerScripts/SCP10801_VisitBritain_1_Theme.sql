-- ***********************************************
-- NAME 		: SCP10801_VisitBritain_1_Theme.sql
-- DESCRIPTION 		: Script to add a new Theme for a Partner - VisitBritain
-- AUTHOR		: Mitesh Modi
...
SET @ThemeId = 2
SET @ThemeName = 'VisitBritain'
-- set the most common domains
SET @Domain1 = 'VisitBritain'
SET @Domain2 = 'visitbritain.transportdirect.info'
SET @Domain3 = 'visitbritain.sitest.transportdirect.info'
SET @Domain4 = 'visitbritain.test.transportdirect.info'
...
SET @ScriptNumber = 10801
SET @ScriptDesc = 'New theme added for VisitBritain'
