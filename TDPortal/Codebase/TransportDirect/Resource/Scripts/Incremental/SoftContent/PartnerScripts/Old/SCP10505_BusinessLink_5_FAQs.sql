-- *************************************************************************************
-- NAME 		: SCP10505_BusinessLink_5_FAQs.sql
-- DESCRIPTION  : FAQs (Full Set) - modified for Businesslink
-- AUTHOR		: XXXX
-- *************************************************************************************
...
SET @ScriptNumber = 10505
SET @ScriptDesc = 'Updates to FAQs - Businesslink'


DECLARE @VersionInfo VARCHAR(24)
SET @VersionInfo = '$Revision:   1.59  $'
