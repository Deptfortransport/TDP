-- *************************************************************************************
-- NAME 		: SCP10101_WhiteLabel_5_FAQs_All.sql
-- DESCRIPTION  : The full set of FAQs amended for WhiteLabel sites:
-- 			    : Most instances of "Transport Direct" has been renamed to "the Journey Planner"
--			    : "Contact us" and "About us" changed to "Contact Transport Direct"...
-- AUTHOR		: Mitesh Modi
-- *************************************************************************************
...
<div class="hdtypethree"><a id="AccessiblePlanning" name="AccessiblePlanning"></a><h2>19. Accessible Journey Planning</h2></div>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.1">19.1) What information do you provide about accessible services, and which areas are covered?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.2">19.2) How accurate is your information on accessible journeys?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.3">19.3) What do you mean by ''assistance''?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.4">19.4) Why do you include journey legs that require assistance in your ''step-free only'' results?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.5">19.5) Why do I need to book in advance?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.6">19.6) How can I book in advance?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.7">19.7) How does the ''Find Nearest Accessible Stop'' work?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.8">19.8) How can I get to the nearest accessible station or stop?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.9">19.9) Can I choose an accessible journey that only uses particular types of transport?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.10">19.10) Can I obtain more information about the accessibility of a station?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.11">19.11) Can you provide fares information?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.12">19.12) Why didn''t I get any results for my accessible journey?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.13">19.13) I don''t believe a service, station or stop included in your journey results is accessible.  Can you correct this?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.14">19.14) Can I use my mobility scooter on public transport?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.15">19.15) Why can''t I plan to an airport, even though I know it is accessible?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpAccessibleJourneyPlanning.aspx#A19.16">19.16) How do I find out about live incidents on the transport network once my journey has started?</a></p>
<div align="right"><a class="jpt" href="#logoTop">Top of page <img alt="Go to top of page" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpUsing.aspx#A13.12">13.12) cy What is social bookmarking?</a></p>
<div align="right"><a name="EnablingIntelligentTravel"></a><a class="jpt" href="#logoTop">Yn &#244;l i''r brig <img alt="Yn cl &#13;&#10;i&#8217;r brig" src="/Web2/App_Themes/TransportDirect/images/gifs/SoftContent/uarrow_icon_slim.gif" border="0" /></a></div>
...
<DIV id="hdtypethree"><A id="TouristInformation" name="TouristInformation"></A><h2>17. CY - Transport Direct Tourist Information</h2></DIV>
<P class="rsviewcontentrow"><A href="/Web2/Help/HelpTouristInfo.aspx#A17.1">17.1)&nbsp;CY - How can I find travel information when visiting from abroad?</A></P>
<P class="rsviewcontentrow"><A href="/Web2/Help/HelpTouristInfo.aspx#A17.2">17.2)&nbsp;CY - How can I find tourist information when visiting from abroad?</A></P>
<P class="rsviewcontentrow"><A href="/Web2/Help/HelpTouristInfo.aspx#A17.3">17.3)&nbsp;CY - Can I book tickets on Transport Direct from abroad?</A></P>
...
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.12">2.12) Sut y gallaf ddarganfod am hygyrchedd y mathau o gludiant yn y siwrnai?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.13">2.13) cy Does Transport Direct offer walk planning? </a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.14">2.14) cy How can I find the detailed directions for a walk?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.15">2.15) cy In which areas will I see a link to the walkit.com site?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.16">2.16) A yw gwybodaeth amser real yn cael ei chynnwys yng nghynllun fy siwrnai?</a></p>
<p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.17">2.17) Ni allaf ddarganfod y lle yr wyf eisiau teithio ohono/iddo?</a></p>
<!-- <p class="rsviewcontentrow"><a href="/Web2/Help/HelpJplan.aspx#A2.18">2.18) How do I plan journeys to destinations outside Great Britain?</a></p> -->
<p>&nbsp;</p>
...
<h3><a class="QuestionLink" id="A2.13" name="A2.13">2.13) Does Transport Direct offer walk planning?</a></h3>
...
IF @ptrValText IS NOT NULL BEGIN
   ...
   UPDATETEXT [dbo].[tblContent].[Value-Cy] @ptrValText NULL 0 ' but it might not display the site as designed, nor provide you with the best experience of using the website.</p>
<p>&nbsp;</p>
<p>Please note that the site does not support the use of Internet Explorer on Macs.&nbsp; We recommend Mac users use Macintosh Safari.&nbsp;</p>
<p>&nbsp;</p>
<p>Accessing Transport Direct in more than one window within the same browser session may cause a serious error.&nbsp; In order to view Transport Direct in more than one window please open a new browser session rather than opening a new window (or tab) within the same browser.&nbsp;</p>
...
'<div id="primcontent">
	<div id="contentarea">
		<div class="hdtypethree"><a id="TouristInformation" name="TouristInformation"></a><h2>17. CY - Transport Direct 
		...
		<div class="hdtypethree">
			...
			<h3><a class="QuestionLink" id="A2" name="A17.1"></a>17.1)&nbsp;CY - How can I find travel 
					information when visiting from abroad?</h3>
		<p>Transport Direct currently covers travel across Great Britain (England, Wales 
			and Scotland); you can plan your GB journey on Transport Direct from anywhere 
			around the world.</p>
		<h3><a class="QuestionLink" id="A3" name="A17.2"></a>17.2)&nbsp;CY - How can I find tourist 
				information when visiting from abroad?</h3>
		<p>Information on tourist destinations and accommodation in Britain can be found at <a href="http://www.visitbritain.com" target="_child">
				www.visitbritain.com <img src="/Web2/App_Themes/TransportDirect/images/gifs/newwindow.gif" alt="(opens in new window)"></a>.</p>
		<h3><a class="QuestionLink" id="A4" name="A17.3"></a>17.3)&nbsp;CY - Can I book tickets on 
				Transport Direct from abroad?</h3>
		<p>Yes, you can book tickets from abroad through our retail partners but tickets 
			may have to be collected at the relevant departure station.</p>
		<p>&nbsp;</p>
...
<p>Transport Direct has launched the first version of our new cycle planner. This currently enables cycle planning in the areas listed in FAQ 16.2 below. 
It is now our intention to get feedback from users and experts regarding the new planner and the data that it uses.
</p>
<br />
...
<p>The drop down on the ‘Find a cycle route’ allows you to select a number of different parameters for your journey. So just by selecting your preferred option from the drop down menu marked ‘Type of journey’ you can plan your journey using the following options:</p>
<ul class="listerdisc">
<li>“Quietest” ” if you would like a route that prioritises the use of cycle paths, cycle lanes, quiet streets and routes recommended for cycling. (This is the default option of the cycle journey planner)</li>
...
<p>Transport Direct has launched the first version of our new cycle planner. This currently enables cycle planning in the areas listed in FAQ 16.2 below. 
It is now our intention to get feedback from users and experts regarding the new planner and the data that it uses.</p>
<br />
...
<p>Mae''r gwymplen ‘Canfod llwybr beicio’ yn eich galluogi i ddewis nifer o wahanol ffiniau ar gyfer eich siwrnai. Felly, dim ond drwy ddewis eich hoff ddewis o''r gwymplen ''Math o siwrnai'' y gallwch drefnu eich siwrnai gan ddefnyddio''r dewisiadau canlynol:</p>
<ul class="listerdisc">
...
<li>“Cyflymaf” os hoffech lwybr â''r amser beicio byrraf.</li>
<li>“Mwyaf hamddenol” os hoffech lwybr sy''n rhoi blaenoriaeth i feicio drwy barciau a mannau gwyrdd yn ogystal â defnyddio llwybrau beicio, lonydd beicio, strydoedd tawel a llwybrau a argymhellir ar gyfer beicio.</li>
</ul>
<br />
...
<p class="rsviewcontentrow"><a href="#A19.1">19.1) What information do you provide about accessible services, and which areas are covered?</a></p>
<p class="rsviewcontentrow"><a href="#A19.2">19.2) How accurate is your information on accessible journeys?</a></p>
<p class="rsviewcontentrow"><a href="#A19.3">19.3) What do you mean by ''assistance''?</a></p>
<p class="rsviewcontentrow"><a href="#A19.4">19.4) Why do you include journey legs that require assistance in your ''step-free only'' results?</a></p>
<p class="rsviewcontentrow"><a href="#A19.5">19.5) Why do I need to book in advance?</a></p>
<p class="rsviewcontentrow"><a href="#A19.6">19.6) How can I book in advance?</a></p>
<p class="rsviewcontentrow"><a href="#A19.7">19.7) How does the ''Find Nearest Accessible Stop'' work?</a></p>
<p class="rsviewcontentrow"><a href="#A19.8">19.8) How can I get to the nearest accessible station or stop?</a></p>
<p class="rsviewcontentrow"><a href="#A19.9">19.9) Can I choose an accessible journey that only uses particular types of transport?</a></p>
<p class="rsviewcontentrow"><a href="#A19.10">19.10) Can I obtain more information about the accessibility of a station?</a></p>
<p class="rsviewcontentrow"><a href="#A19.11">19.11) Can you provide fares information?</a></p>
<p class="rsviewcontentrow"><a href="#A19.12">19.12) Why didn''t I get any results for my accessible journey?</a></p>
<p class="rsviewcontentrow"><a href="#A19.13">19.13) I don''t believe a service, station or stop included in your journey results is accessible.  Can you correct this?</a></p>
<p class="rsviewcontentrow"><a href="#A19.14">19.14) Can I use my mobility scooter on public transport?</a></p>
<p class="rsviewcontentrow"><a href="#A19.15">19.15) Why can''t I plan to an airport, even though I know it is accessible?</a></p>
<p class="rsviewcontentrow"><a href="#A19.16">19.16) How do I find out about live incidents on the transport network once my journey has started?</a></p>

<div>&nbsp;</div>
<div class="hdtypethree"><h2>19. Accessible Journey Planning</h2></div>
<br />

<h3><a class="QuestionLink" id="A19.1" name="A19.1"></a>19.1) What information do you provide about accessible services, and which areas are covered?</h3>
...
<h3><a class="QuestionLink" id="A19.2" name="A19.2"></a>19.2) How accurate is your information on accessible journeys?</h3>
...
<h3><a class="QuestionLink" id="A19.3" name="A19.3"></a>19.3) What do you mean by ''assistance''?</h3>
...
<h3><a class="QuestionLink" id="A19.4" name="A19.4"></a>19.4) Why do you include journey legs that require assistance in your ''step-free only'' results?</h3>
...
<h3><a class="QuestionLink" id="A19.5" name="A19.5"></a>19.5) Why do I need to book in advance?</h3>
...
<h3><a class="QuestionLink" id="A19.6" name="A19.6"></a>19.6) How can I book in advance?</h3>
...
<h3><a class="QuestionLink" id="A19.7" name="A19.7"></a>19.7) How does the ''Find Nearest Accessible Stop'' work?</h3>
...
<h3><a class="QuestionLink" id="A19.8" name="A19.8"></a>19.8) How can I get to the nearest accessible station or stop?</h3>
...
<h3><a class="QuestionLink" id="A19.9" name="A19.9"></a>19.9) Can I choose an accessible journey that only uses particular types of transport?</h3> 
...
<h3><a class="QuestionLink" id="A19.10" name="A19.10"></a>19.10) Can I obtain more information about the accessibility of a station?</h3>
...
<h3><a class="QuestionLink" id="A19.11" name="A19.11"></a>19.11) Can you provide fares information?</h3>
...
<h3><a class="QuestionLink" id="A19.12" name="A19.12"></a>19.12) Why didn''t I get any results for my accessible journey?</h3>
...
<h3><a class="QuestionLink" id="A19.13" name="A19.13"></a>19.13) I don''t believe a service, station or stop included in your journey results is accessible.  Can you correct this?</h3>
...
<h3><a class="QuestionLink" id="A19.14" name="A19.14"></a>19.14) Can I use my mobility scooter on public transport?</h3>  
...
<h3><a class="QuestionLink" id="A19.15" name="A19.15"></a>19.15) Why can''t I plan to an airport, even though I know it is accessible?</h3>
...
<h3><a class="QuestionLink" id="A19.16" name="A19.16"></a>19.16) How do I find out about live incidents on the transport network once my journey has started?</h3>
...
SET @ScriptNumber = 10101
SET @ScriptDesc = 'Updates to FAQs - modified for generic partner'


DECLARE @VersionInfo VARCHAR(24)
SET @VersionInfo = '$Revision:   1.57  $'
