-- *************************************************************************************
-- NAME 		: SCP10905_CycleRoutes_Cycle_5_FAQs.sql
-- DESCRIPTION  : The FAQs amended for CycleRoutes Cycle WhiteLabel site:
...
SET @ScriptNumber = 10905
SET @ScriptDesc = 'The FAQs amended for CycleRoutes Cycle WhiteLabel site'


DECLARE @VersionInfo VARCHAR(24)
SET @VersionInfo = '$Revision:   1.22  $'
