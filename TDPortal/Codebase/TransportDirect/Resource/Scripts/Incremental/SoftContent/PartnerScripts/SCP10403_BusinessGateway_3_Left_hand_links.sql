-- ***********************************************
-- NAME 		: SCP10403_BusinessGateway_3_Left_hand_links.sql
-- DESCRIPTION 	: Script to add all the left hand links for a Theme - BusinessGateway
-- AUTHOR		: Phil Scott
-- DATE			: 12 May 2009 
-- ************************************************
...
SET @ScriptNumber = 10403
SET @ScriptDesc = 'Added left hand links for theme BusinessGateway update'


DECLARE @VersionInfo VARCHAR(24)
SET @VersionInfo = '$Revision:   1.7  $'
