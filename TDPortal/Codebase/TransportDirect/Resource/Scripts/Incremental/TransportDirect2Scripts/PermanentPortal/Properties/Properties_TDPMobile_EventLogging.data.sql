-- ***********************************************
-- NAME           : 
-- DESCRIPTION    : TDPMobile EventLogging properties data
-- AUTHOR         : Mitesh Modi
-- DATE           : 26 Jun 2013
-- ***********************************************
USE [PermanentPortal]
...
------------------------------------------------
-- 'TDPMobile' EventLogging properties
------------------------------------------------
...
-- =============================================
EXEC [PermanentPortal].[dbo].[UpdateChangeCatalogue] 9999, 'TDPMobile EventLogging properties data'