-- ***********************************************
-- NAME           : DUP2077_GetRetailers.proc.sql
-- DESCRIPTION    : GetRetailers stored procedure update
-- AUTHOR         : Mitesh Modi
-- DATE           : 26 Jun 2013
-- ***********************************************
USE [PermanentPortal]
...
-- =============================================
EXEC [PermanentPortal].[dbo].[UpdateChangeCatalogue] 2077, 'GetRetailers stored procedure update'
