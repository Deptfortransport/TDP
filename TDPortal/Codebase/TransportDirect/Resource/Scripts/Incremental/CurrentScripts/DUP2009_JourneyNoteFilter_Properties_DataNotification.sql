-- ***********************************************
-- NAME 		: DUP2009_JourneyNoteFilter_Properties_DataNotification.sql
-- DESCRIPTION 	: Add journey note filter data notification to properties table
-- AUTHOR		: Mitesh Modi
-- DATE			: 19 Mar 2013
-- ************************************************
...
DECLARE @changeNotifGroup varchar(100) = 'JourneyNoteFilter'
DECLARE @changeNotifTable varchar(100) = 'JourneyNoteFilter'
...
SET @ScriptNumber = 2009
SET @ScriptDesc = 'Add journey note filter data notification to properties table'
