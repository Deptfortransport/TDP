-- ***********************************************
-- AUTHOR      	: Phil Scott
-- Title        : DUP2083_Add_C2S_EES_Partner
-- DESCRIPTION 	: Adds C2C to EES
...
-- "EESTID","Desc"
-- Password: C250ftw4r3# 
-- PROD: crypt@aaoOA9kJAZOGqxe9QA5A2DBSmvfWgsLEofZHGecz/f8=
-- DEV:  crypt@3ANh8MoeifmGZR/zIBx61JgR9q0ZvO2/OHuk9qizox4=
...
set @partnerid = 145
set @hostname = 'C2Software'
set @Partnername = 'C2Software'
set @Channel = 'EES' 

-- DEV
set @PartnerPassword = '3ANh8MoeifmGZR/zIBx61JgR9q0ZvO2/OHuk9qizox4='
-- PROD
-- set @PartnerPassword = 'aaoOA9kJAZOGqxe9QA5A2DBSmvfWgsLEofZHGecz/f8='
...
-- Use Reporting
-- insert into Partner values (145, 'C2Software', 'C2Software', 'EES',null)
-- go
...
SET @ScriptNumber = 2083
SET @ScriptDesc = 'DUP2081_Add_C2S_EES_Partner'
