-- ***********************************************
-- NAME           : DUP2068_ImportUndergroundStatusData.proc.sql
...
BEGIN
	...
	SET @XMLPathData =  '/ArrayOfLineStatus/LastUpdated'

	SET @LastUpdated = 
	(SELECT DISTINCT
		X.[LastUpdated] as datetime
	FROM
...
-- =============================================
EXEC [PermanentPortal].[dbo].[UpdateChangeCatalogue] 2068, 'ImportUndergroundStatusData stored procedure'
