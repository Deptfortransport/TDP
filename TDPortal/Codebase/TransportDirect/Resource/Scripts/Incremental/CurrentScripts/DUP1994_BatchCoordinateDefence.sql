-- ***********************************************
-- NAME 		: DUP1994_BatchCoordinateDefence.sql
-- DESCRIPTION 	: Update Batch with bad coordinate defence
-- AUTHOR		: David Lane
-- DATE			: 08 Feb 2013
-- ************************************************
...
GO
/****** Object:  StoredProcedure [dbo].[AddBatchRequest]    Script Date: 02/07/2013 14:25:32 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SET @MaxEasting = 1000000
	DECLARE @MaxNorthing INT
	SET @MaxNorthing = 1000000
...
SET @ScriptNumber = 1994
SET @ScriptDesc = 'Batch coordinate defence'
