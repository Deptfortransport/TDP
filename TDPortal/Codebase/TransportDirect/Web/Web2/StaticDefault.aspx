...
<%@ Page Language="c#" Codebehind="StaticDefault.aspx.cs" ValidateRequest="false"
    AutoEventWireup="true" Inherits="TransportDirect.UserPortal.Web.StaticDefault" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="<%=TransportDirect.Common.TDCultureInfo.CurrentUICulture.Name%>" xmlns="http://www.w3.org/1999/xhtml">
<head>
    <link rel="canonical" href="http://www.transportdirect.info/Web2/staticdefault.aspx" />
    <cc1:HeadElementControl ID="headElementControl" runat="server" Stylesheets="setup.css,jpstd.css,homepage.css,expandablemenu.css, nifty.css,MapIncidents.css, FooterPages.css">
    </cc1:HeadElementControl>
    <meta name="ROBOTS" content="NOODP" />
    <meta name="description" content="Answers to frequently asked questions about Transport Direct." />    
</head>
<body>
