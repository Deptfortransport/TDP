...
namespace TransportDirect.UserPortal.Web.Controls
{
    ...
    public partial class LocationControl : TDUserControl
    {
        ...
        /// Allows page in ambiguity mode (after submit called) to specify the valid location should be shown as fixed
        /// </summary>
        ...
        /// <summary>
        /// Read/Write property to set the show more options expanded flag after the initialise has already been called.
        /// Allows page in postback mode to specify the location control should show more options expanded, e.g. to 
        /// persist if user has selected more options
        /// </summary>
        public bool ShowMoreOptionsExpanded
        {
            get { return showMoreOptionsExpanded; }
            set { showMoreOptionsExpanded = value; }
        }

        /// <summary>
        /// Read only property to return if more option is expanded (either as initialised or if user selected)
        /// </summary>
        public bool MoreOptionSelected
        {
            get { return IsMoreOptionsSelectedJavascript() || IsMoreOptionsSelected(); }
        }
        ...
        {
            if (IsMoreOptionsSelectedJavascript())
            {
        ...
        /// <summary>
        /// Returns true if the more options have been selected by the user (set by javascript)
        /// </summary>
        private bool IsMoreOptionsSelectedJavascript()
        {
