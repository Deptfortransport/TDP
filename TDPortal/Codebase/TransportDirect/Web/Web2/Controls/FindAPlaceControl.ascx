<%@ Control Language="c#" AutoEventWireup="True" Codebehind="FindAPlaceControl.ascx.cs" Inherits="TransportDirect.UserPortal.Web.Controls.FindAPlaceControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<%@ Register TagPrefix="cc1" Namespace="TransportDirect.UserPortal.Web.Controls" Assembly="td.userportal.web" %>
<table class="HPControlLayoutTable">
	<tr>
		<td align="right" class="HomepageControlColumn1">
			<asp:label id="labelPlace" associatedcontrolid="textBoxPlace" runat="server" enableviewstate="false" cssclass="txtsevenb"></asp:label>
		</td>
		...
		<td rowspan="2" align="center" class="HomepageControlColumn3">
			<asp:hyperlink id="hyperlinkFindAPlaceMore" runat="server" enableviewstate="false">
				<cc1:tdimage id="imageMap" runat="server" width="58" height="44"></cc1:tdimage>
			</asp:hyperlink>
		</td>
	</tr>
	<tr>
		<td align="right">
			<asp:label id="labelPlaceTypeScreenReader" associatedcontrolid="dropDownLocationGazetteerOptions" runat="server" cssclass="screenreader" enableviewstate="false"></asp:label> 
		</td>
		<td align="left" class="HomepageControlColumn2">
	...
	<tr>
		<td align="right" class="HomepageControlColumn1">
			<asp:label id="textBoxShowOption" associatedcontrolid="dropDownLocationShowOptions" runat="server" enableviewstate="false" cssclass="txtsevenb"></asp:label>
		</td>
