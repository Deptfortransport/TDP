...
namespace TransportDirect.UserPortal.Web.Controls
{
	...
	{	
		...
		protected void Page_Init(object sender, System.EventArgs e)
		{
			...
			PageOptionsControl.ShowAdvancedOptions += new EventHandler(this.OnShowCarDetails);
            PageOptionsControl.HideAdvancedOptions += new EventHandler(this.OnHideCarDetails);
		...
		protected void Page_PreRender(object sender, System.EventArgs e)
		{
            ...
            #region Preferences panel visibility

            // Assume preferences panel visibility remains the same
            bool showPreferences = PreferencesVisible;

			if (AmbiguityMode) 
			{
                // If any preferences are selected, then this preferences control is to be displayed
                showPreferences = (PreferencesSelected);
			} 
			
            // And update the preferences panel visibility, this will also raise an event for any interested page,
            // where the panel visibility changes
            ...
            if (!PageOptionsControl.AllowShowAdvancedOptions)
			{
        ...
        public bool PreferencesSelected
        {
            get
            {
                return
                    ...
                    || !DrivingSpeedIsDefault()
                    || !DoNotUseMotorwaysIsDefault()
                    || !CarSizeIsDefault()
                    || !FuelTypeIsDefault()
                    || !FuelUseUnitIsDefault()
                    || !FuelConsumptionOptionIsDefault()
                    || !FuelCostOptionIsDefault()
                    || journeyOptionsControl.PreferencesSelected);
            }
        }
		...
		/// <summary>
		/// Gets/Sets input fuel consumption value
		/// </summary>
        ...
        /// <summary>
        /// Gets/Sets fuel consumption text
        /// </summary>
		...
		{
            // COMMENTED OUT AS THE FOLLOWING IS DUPLICATED IN THE FindCarJourneyOptionsControl AND THEREFORE 
            // NOT NECESSARY. RETAINED IN CASE IT IS NEEDED!
            ...
            //{
            //    // TristateLocationControl being used for Via location
            //    if (journeyOptionsControl.TristateLocationControl.Visible && !journeyOptionsControl.ShowLocationControlAutoSuggest)
            //    {
            //        if (AmbiguityMode
            ...
            //    // LocationControl being used for Via location
            //    if (journeyOptionsControl.LocationControl.Visible && journeyOptionsControl.ShowLocationControlAutoSuggest)
            //    {
            //        if (AmbiguityMode
        ...
        /// <summary>
        /// Returns true if the do not use motorways check is the default value (unchecked), false otherwise
        /// </summary>
        /// <returns></returns>
        private bool DoNotUseMotorwaysIsDefault()
        {
            if (DoNotUseMotorways == true)
            {
                // Its checked, so not default
                return false;
            }
		...
		private bool FuelUseUnitIsDefault() 
		{
		...
		private bool FuelConsumptionOptionIsDefault() 
		{
        ...
        private bool FuelCostOptionIsDefault() 
		{
		...
		private void UpdateChangesControl()
		{
            ...
            bool showMotorwaysChange = !DoNotUseMotorwaysIsDefault();
            ...
            switch (journeyTypeDisplayMode)
			{
				...
				case GenericDisplayMode.Ambiguity:
                    ...
                    panelTypeOfJourney.Visible = showSpeedChange || showTypeChange || showMotorwaysChange;
					break;
            ...
            #region Do not use motorways

            // DoNotUseMotorways visibility
            if (AmbiguityMode && showMotorwaysChange)
            {
            ...
            // Set visibility of the login/save preferences panel
            // Set visibility of the preferences options title 
        ...
        /// <summary>
        /// Sets display labels visibility
        /// </summary>
        /// <param name="visibility"></param>
        private void ShowDisplayLabels(bool visibility) 
		{
