// *********************************************** 
// NAME                 : D2DCarJourneyOptionsControl.ascx
// AUTHOR               : David Lane
// DATE CREATED         : 09/01/2013 
// DESCRIPTION          : Displays /allows input of 
//                        car journey options preferences.                           .
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/Web2/Controls/D2DCarJourneyOptionsControl.ascx.cs-arc  $   
//
//   Rev 1.0   Jan 10 2013 16:33:46   DLane
//Initial revision.
...
namespace TransportDirect.UserPortal.Web.Controls
{
	...
	/// <summary>
	///		Summary description for D2DCarJourneyOptionsControl.
	/// </summary>
	[System.Runtime.InteropServices.ComVisible(false)]
	public partial  class D2DCarJourneyOptionsControl : TDUserControl
	{
		#region controls
		...
		/// <summary>
		/// Readonly property for journey options panel property
		/// </summary>
		public Panel JourneyOptionsPanel
		{
			get
			{
				return panelJourneyOptions;
			}
		}
		...
		/// <summary>
		/// Read only property to indicate new location is clicked
		/// </summary>
