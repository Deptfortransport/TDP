...
// page
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/Web2/SiteMapDefault.aspx.cs-arc  $:
//
//   Rev 1.3   Jul 28 2011 16:17:34   DLane
...
namespace TransportDirect.UserPortal.Web
{
	...
	public partial class SiteMapDefault : TDPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			//baseliteralURL.Text = baseliteralURL.Substring(0, urlStart) + Request.Url.Host 
			//	+ baseliteralURL.Substring(slash, baseliteralURL.Length - slash);

            // Populate page title
            lblSiteMapTitle.Text = GetResource("SiteMapDefault.lblSiteMapTitle");

            // Populate browser title
            this.PageTitle = GetResource("SiteMapDefault.lblSiteMapTitle") + " | Transport Direct";
		}
