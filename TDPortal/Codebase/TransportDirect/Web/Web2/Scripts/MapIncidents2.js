...
{	
	...
	var containerTop = document.getElementById('maph').offsetTop;
	var containerHeight = document.getElementById('maph').offsetHeight;
	...
	if (documentHeight - labelOffsetY > (divY + labelOffsetY + ITEM_HEIGHT))
	{
	   
	    document.getElementById('incidentDetails').style.top = "" + (divY + labelOffsetY - ITEM_HEIGHT ) + "px";
	}
		
	if(containerTop > divY + labelOffsetY - ITEM_HEIGHT)
	{
	    
	    document.getElementById('incidentDetails').style.top = "" + (divY + labelOffsetY) + "px";
	}
	
	if(containerTop + containerHeight < divY + labelOffsetY - ITEM_HEIGHT)
	{
