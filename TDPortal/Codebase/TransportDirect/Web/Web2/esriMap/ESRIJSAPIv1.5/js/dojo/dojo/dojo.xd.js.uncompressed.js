...
dojo.registerModulePath("dojo", djConfig.esriJSAPI+"js/dojo/dojo");
dojo.registerModulePath("dijit", djConfig.esriJSAPI+"js/dojo/dijit");
dojo.registerModulePath("dojox", djConfig.esriJSAPI+"js/dojo/dojox");
