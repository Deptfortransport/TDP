<%@ Control Language="c#" AutoEventWireup="True" Codebehind="JourneyAdjustSegmentControl.ascx.cs" Inherits="TransportDirect.UserPortal.Web.Controls.JourneyAdjustSegmentControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<itemtemplate>
				<div id="interchangeDiv" runat="server">
					<tr id="interchangeTableRow1">
						...
						<td class="txteightbgrey" align="right" rowspan="3">
				...
				<tr>
					...
					<td align="center" style="padding-bottom: 10px; padding-top: 10px">
						<table>
							<tr>
								<td align="center">
									<cc1:tdimage id="imageMode" runat="server" imageurl="<%# GetModeImageUrl((PublicJourneyDetail)Container.DataItem)%>" alternatetext="<%# GetModeImageAlternateText( (PublicJourneyDetail)Container.DataItem ) %>"></cc1:tdimage>
								</td>
							</tr>
							<tr>
								<td align="center">
					...
					<td valign="middle" class="txteight" colspan="2" style="padding:5px">
						&nbsp;
					</td>
				</tr>
			</itemtemplate>
