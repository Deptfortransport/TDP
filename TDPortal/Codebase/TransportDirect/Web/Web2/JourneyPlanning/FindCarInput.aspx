...
<%@ Page Language="c#" Codebehind="FindCarInput.aspx.cs" AutoEventWireup="True" Inherits="TransportDirect.UserPortal.Web.Templates.FindCarInput" %>
...
<head>
    <link rel="canonical" href="http://www.transportdirect.info/Web2/JourneyPlanning/FindCarInput.aspx" />
    <meta name="description" content="Plan your car journey with Transport Direct's car route planner. Get maps, step-by-step directions and car park information." />
    <meta name="keywords" content="car route planner, car route, carbon emissions, car park, nearest car park, car directions, car parking, driving directions, maps, CO2 emissions, carbon counter"></meta>
    <cc1:HeadElementControl ID="headElementControl" runat="server" Stylesheets="homepage.css,nifty.css,setup.css,jpstd.css,ExpandableMenu.css,CalendarSS.css,map.css,FindCarInput.aspx.css">
    </cc1:HeadElementControl>
    <uc1:AnalyticsControl id="analyticsControl" runat="server"></uc1:AnalyticsControl>
</head>
<body dir="ltr">
	<div id="SkipToMainContentArea" class="SkipToMainContentArea">
	    <a id="skipToMainContentLink" onfocus="this.className='HackFocusSkipMain';" onblur="this.className='SkipToMainContentLink';" href="#FindACar" tabindex="1" class="SkipToMainContentLink">Skip to main content</a>
	</div>
    <div class="CenteredContent">
        <form id="FindCarInput" method="post" runat="server">
            <div class="spotlighttag">
                <!-- Start of DoubleClick Spotlight Tag: Please do not remove-->
                <!-- Activity Name for this tag is:Car route finder -->
                <!-- Web site URL where tag should be placed: http://www.transportdirect.info/Web2/JourneyPlanning/FindCarInput.aspx -->
                <!-- This tag must be placed within the opening <body> tag, as close to the beginning of it as possible-->
                <!-- Creation Date:1/22/2010 -->
                <script type="text/javascript" id="DoubleClickFloodlightTag637076">
                    //<![CDATA[
                    var axel = Math.random() + "";
                    var a = axel * 10000000000000;
                    document.write('<iframe title="Not user content" style="display:none" src="http://fls.doubleclick.net/activityi;src=1501791;type=trans304;cat=carou341;ord=1;num=' + a + '?" width="1" height="1" frameborder="0"></iframe>');
                    //]]>
                </script>
                <noscript>
                <iframe title="Not user content" style="display:none" src="http://fls.doubleclick.net/activityi;src=1501791;type=trans304;cat=carou341;ord=1;num=1?" width="1" height="1" frameborder="0"></iframe>
                </noscript>
                                        ...
                                        <div class="toptitlediv">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <a name="FindACar"></a>
                                                        <cc1:TDImage ID="imageFindACar" runat="server" Width="62" Height="36"></cc1:TDImage>
                                                    </td>
                                                    <td>
                                                        <h1>
