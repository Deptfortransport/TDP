<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintableEBCJourneyDetails.aspx.cs" Inherits="TransportDirect.UserPortal.Web.JourneyPlanning.PrintableEBCJourneyDetails" %>
...
<head>
    <cc2:HeadElementControl ID="headElementControl" runat="server" Stylesheets="setup.css,jpstdprint.css,PrintableEBCJourneyMap.aspx.css,MapPrint.css"></cc2:HeadElementControl>
</head>
<body>
    <div class="CenteredContent">
        <form id="PrintableJourneyMap" method="post" runat="server">
            ...
            <div>
                <cc2:TDMap ID="map" runat="server" Width="784px" Height="400px" />
            </div>
        </form>
    </div>       
</body>
