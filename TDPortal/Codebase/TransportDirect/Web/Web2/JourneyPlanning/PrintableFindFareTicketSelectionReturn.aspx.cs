...
//                        page
// ******************************************************************
//$Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/Web2/JourneyPlanning/PrintableFindFareTicketSelectionReturn.aspx.cs-arc  $
//
...
//
//   Rev 1.0   Mar 30 2005 17:09:42   tmollart
//Initial revision.
//
...
namespace Web.Templates
{
	...
	/// </summary>
	public partial class PrintableFindFareTicketSelectionReturn : TDPrintablePage, INewWindowPage
	{
		//Label controls
		...
		public PrintableFindFareTicketSelectionReturn() : base()
		{
			LocalResourceManager = TDResourceManager.FIND_A_FARE_RM;
			pageId = PageId.PrintableFindFareTicketSelectionReturn;
		}
