...
<%@ Page Language="c#" Codebehind="FindCoachInput.aspx.cs" AutoEventWireup="True"
    Inherits="TransportDirect.UserPortal.Web.Templates.FindCoachInput" %>
...
<head>
    <link rel="canonical" href="http://www.transportdirect.info/Web2/JourneyPlanning/FindCoachInput.aspx" />
    <meta name="description" content="Plan a coach journey, get coach times and compare fares with Transport Direct." />
    <meta name="keywords" content="coach schedules,coach times,coach planner,coach timetable,coach travel,coach services" />
    <link rel="image_src" href="http://www.transportdirect.info/Web2/App_Themes/TransportDirect/images/gifs/softcontent/en/finda_coach.gif" />
    <cc1:HeadElementControl ID="headElementControl" runat="server" Stylesheets="setup.css,jpstd.css,homepage.css,CalendarSS.css,expandablemenu.css,nifty.css,findCoachInput.aspx.css">
    </cc1:HeadElementControl>
    <uc1:AnalyticsControl id="analyticsControl" runat="server"></uc1:AnalyticsControl>
</head>
<body dir="ltr">
	<div id="SkipToMainContentArea" class="SkipToMainContentArea">
	    <a id="skipToMainContentLink" onfocus="this.className='HackFocusSkipMain';" onblur="this.className='SkipToMainContentLink';" href="#FindACoach" tabindex="1" class="SkipToMainContentLink">Skip to main content</a>
	</div>
    <div class="CenteredContent">
        <form id="FindCoachInput" method="post" runat="server">
            <div class="spotlighttag">
                <!-- Start of DoubleClick Spotlight Tag: Please do not remove-->
                <!-- Activity Name for this tag is:Transport Direct - Find a Coach -->
                <!-- Web site URL where tag should be placed: http://www.transportdirect.info/Web2/JourneyPlanning/FindCoachInput.aspx -->
                <!-- This tag must be placed within the opening <body> tag, as close to the beginning of it as possible-->
                <!-- Creation Date:1/8/2010 -->
                <script type="text/javascript" id="DoubleClickFloodlightTag631076">
                //<![CDATA[
                var axel = Math.random()+"";
                var a = axel * 10000000000000;
                document.write('<iframe title="Not user content" style="display:none" src="http://fls.uk.doubleclick.net/activityi;src=1501791;type=trans304;cat=coach01;ord=1;num=' + a + '?" width="1" height="1" frameborder="0"></iframe>');
                //]]>
                </script>
                <noscript>
                <iframe title="Not user content" style="display:none" src="http://fls.uk.doubleclick.net/activityi;src=1501791;type=trans304;cat=coach01;ord=1;num=1?" width="1" height="1" frameborder="0"></iframe>
                </noscript>
                                        ...
                                        <div class="toptitlediv">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <a name="FindACoach"></a>
                                                        <cc1:TDImage ID="imageFindACoach" runat="server" Width="62" Height="36"></cc1:TDImage>
                                                    </td>
                                                    <td>
                                                        <h1>
