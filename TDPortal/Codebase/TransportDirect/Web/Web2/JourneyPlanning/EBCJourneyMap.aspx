<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EBCJourneyMap.aspx.cs" Inherits="TransportDirect.UserPortal.Web.Templates.EBCJourneyMap" %>
...
<head>
    <cc1:HeadElementControl ID="headElementControl" runat="server" Stylesheets="homepage.css,nifty.css,setup.css,jpstd.css,ExpandableMenu.css,Map.css,EBCJourneyMap.aspx.css">
...
<body>
    ...
    <div class="CenteredContent">
        <form id="EBCJourneyMap" runat="server">
        <div>
            <a href="#JourneyMap"><cc1:TDImage ID="imageMapSkipLink" runat="server" CssClass="skiptolinks" EnableViewState="false"></cc1:TDImage></a>
