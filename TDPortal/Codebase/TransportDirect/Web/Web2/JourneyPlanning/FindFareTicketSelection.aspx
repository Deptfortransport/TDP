...
<%@ Page Language="c#" Codebehind="FindFareTicketSelection.aspx.cs" AutoEventWireup="True"
    Inherits="TransportDirect.UserPortal.Web.Templates.FindFareTicketSelection" %>
...
<head>
    <cc1:HeadElementControl ID="headElementControl" runat="server" Stylesheets="nifty.css,expandablemenu.css,homepage.css,setup.css,jpstd.css,FindAFare.css, FindFareTicketSelection.aspx.css">
                                        ...
                                        <table lang="en" cellspacing="0" width="100%" border="0">
                                            <tr>
                                                <td>
                                                    ...
                                                    <cc1:helplabelcontrol id="helpLabelControl" runat="server" cssmaintemplate="helpboxoutput" visible="false"></cc1:helplabelcontrol>
                                                    <br />
