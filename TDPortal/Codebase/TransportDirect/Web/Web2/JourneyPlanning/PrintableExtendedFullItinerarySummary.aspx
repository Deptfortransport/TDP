...
<%@ Page Language="c#" Codebehind="PrintableExtendedFullItinerarySummary.aspx.cs"
    AutoEventWireup="True" Inherits="TransportDirect.UserPortal.Web.Templates.PrintableExtendedFullItinerarySummary" %>
...
<body>
    <div class="CenteredContent">
        <form id="PrintableExtendedFullItinerarySummary" method="post" runat="server">
            ...
            <div class="boxtypewhitebackground">
                <uc1:ExtendJourneyLineControl ID="extendJourneyLineControl" Visible="true" runat="server">
                </uc1:ExtendJourneyLineControl>
            </div>
