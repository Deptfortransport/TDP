...
<%@ Page language="c#" Codebehind="ServiceDetails.aspx.cs" AutoEventWireup="True" Inherits="TransportDirect.UserPortal.Web.Templates.ServiceDetails" %>
                                        ...
                                        <table lang="en" cellspacing="0" width="100%" border="0">
                                            <tr>
			                                    ...
			                                    <div id="boxtypetwelve">
				                                    <div id="dmtitle"><uc1:serviceheadercontrol id="serviceHeaderControl" runat="server" EnableViewState="False"></uc1:serviceheadercontrol></div>
				                                    <div id="dmview"><br/>
					                                    ...
					                                    <uc1:servicenotescontrol id="serviceNotesControl" runat="server" EnableViewState="False"></uc1:servicenotescontrol><br/>
					                                    <uc1:serviceoperationcontrol id="serviceOperationControl" runat="server" EnableViewState="False"></uc1:serviceoperationcontrol><br/>
				                                    </div>
			                                    </div>
