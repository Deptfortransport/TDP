...
<%@ Page Language="c#" Codebehind="FindFareTicketSelectionSingles.aspx.cs" AutoEventWireup="True"
    Inherits="TransportDirect.UserPortal.Web.Templates.FindFareTicketSelectionSingles" %>
...
<head>
    <cc1:HeadElementControl ID="headElementControl" runat="server" Stylesheets="setup.css,jpstd.css,FindAFare.css,homepage.css,expandablemenu.css,nifty.css,FindFareTicketSelectionSingles.aspx.css">
                                    ...
                                    <table lang="en" cellspacing="0" width="100%" border="0">
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Panel ID="viewReturnsPanel" runat="server">
                                                    <div class="boxtypeeightstd">
                                                        <asp:Label ID="viewReturnsPart1Label" runat="server" EnableViewState="False" CssClass="txtseven"></asp:Label>
                                                        <asp:HyperLink ID="viewReturnsHyperLink" runat="server" EnableViewState="False" CssClass="txtseven"></asp:HyperLink>
                                                        <asp:Label ID="viewReturnsPart2Label" runat="server" EnableViewState="False" CssClass="txtseven"></asp:Label></div>
                                                </asp:Panel>
                                                <br />
                                                <uc1:FindFareTicketSelectionControl ID="outwardTicketSelectionControl" runat="server">
                                                </uc1:FindFareTicketSelectionControl>
                                                <br />
                                                <uc1:FindFareTicketSelectionControl ID="inwardTicketSelectionControl" runat="server">
                                                </uc1:FindFareTicketSelectionControl>
                                                <div class="boxtypeeightstd">
