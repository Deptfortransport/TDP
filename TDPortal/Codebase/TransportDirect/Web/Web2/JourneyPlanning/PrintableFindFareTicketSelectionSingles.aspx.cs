...
//                        page
// ******************************************************************
//$Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/Web2/JourneyPlanning/PrintableFindFareTicketSelectionSingles.aspx.cs-arc  $
//
//   Rev 1.3   Jan 26 2009 12:55:42   apatel
//No change.
...
//
//   Rev 1.0   Nov 08 2007 13:30:40   mturner
//Initial revision.
//
//   Rev 1.3   Feb 23 2006 18:13:18   aviitanen
//Manual merge for Enhanced Exposed Services (stream3129).
//
//   Rev 1.2   Feb 10 2006 15:04:48   build
//Automatically merged from branch for stream3180
//
//   Rev 1.1.1.0   Dec 02 2005 11:28:50   RGriffith
//Changes applied for using new PrintableHeaderControl and HeadElementControl for Homepage Phase2
//
//   Rev 1.1   Nov 18 2005 16:43:40   halkatib
...
//
//   Rev 1.0   Mar 30 2005 17:09:56   tmollart
//Initial revision.
//
...
namespace Web.Templates
{
	...
	/// </summary>
	public partial class PrintableFindFareTicketSelectionSingles : TDPrintablePage, INewWindowPage
	{
		//Label controls
		...
		// Private members
		public PrintableFindFareTicketSelectionSingles() : base()
		{
			LocalResourceManager = TDResourceManager.FIND_A_FARE_RM;
			pageId = PageId.PrintableFindFareTicketSelectionSingles;
		}
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			outwardTicketSelectionControl.Tickets = pageState.OutwardTicketTable;
			...
			inwardTicketSelectionControl.Tickets = pageState.InwardTicketTable;
