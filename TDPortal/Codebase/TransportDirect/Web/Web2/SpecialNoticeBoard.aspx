...
<%@ Page Language="c#" Codebehind="SpecialNoticeBoard.aspx.cs" ValidateRequest="false"
    AutoEventWireup="True" Inherits="TransportDirect.UserPortal.Web.Templates.SpecialNoticeBoard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="<%=TransportDirect.Common.TDCultureInfo.CurrentUICulture.Name%>" xmlns="http://www.w3.org/1999/xhtml">
<head>
    <cc1:HeadElementControl ID="headElementControl" runat="server" Stylesheets="setup.css,jpstd.css,ExtendAdjustReplan.css,homepage.css,expandablemenu.css,nifty.css,SpecialNoticeBoard.aspx.css">
...
<body>
    ...
    <div class="CenteredContent">
        <form id="SpecialNoticeBoard" method="post" runat="server">
                    ...
                    <td>
                        ...
                        <cc1:RoundedCornerControl ID="RoundedCornerControl1" runat="server" InnerColour="White"
                            ...
                            <% /* Main content control table */ %>
                                ...
                                <div class="boxtypeeight">
                                    <asp:Panel ID="SpecialNoticeBoardHtmlPlaceHolder" runat="server">
                                    </asp:Panel>
                                </div>
