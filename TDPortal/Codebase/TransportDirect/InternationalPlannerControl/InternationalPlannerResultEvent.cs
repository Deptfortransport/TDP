...
// DESCRIPTION	: Class which defines a custom event for logging International planner results
// ************************************************ 
//$Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/InternationalPlannerControl/InternationalPlannerResultEvent.cs-arc  $
//
...
{
    /// <summary>
    /// International planner result event class
    /// </summary>
    [Serializable]
    public class InternationalPlannerResultEvent : TDPCustomEvent
    {
        #region Private members
        private string internationalPlannerRequestId;
        private JourneyPlanResponseCategory responseCategory;

        private static InternationalPlannerResultEventFileFormatter fileFormatter = new InternationalPlannerResultEventFileFormatter();
        #endregion
        ...
        public InternationalPlannerResultEvent(string internationalPlannerRequestId,
