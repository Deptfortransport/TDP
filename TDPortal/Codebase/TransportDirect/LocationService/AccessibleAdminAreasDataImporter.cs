// *********************************************** 
// NAME                 : AccessibleAdminAreasDataImporter.cs
// AUTHOR               : Mitesh Modi
// DATE CREATED         : 13/11/2012 
// DESCRIPTION          : DataGateway import task to import Accessible admin areas
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/LocationService/AccessibleAdminAreasDataImporter.cs-arc  $ 
//
//   Rev 1.0   Dec 05 2012 14:28:44   mmodi
//Initial revision.
...
{
    /// <summary>
    /// DataGateway import task to import Accessible admin areas
    /// </summary>
    public class AccessibleAdminAreasDataImporter : DatasourceImportTask
    {
        #region Private Fields

        private string importPropertyName = string.Empty;
        private const string propertyKey = "datagateway.sqlimport.AccessibleAdminAreasData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.AccessibleAdminAreasData.feedname";
        
        private const string logDescription = "Accessible AdminAreas Import";
        ...
        public AccessibleAdminAreasDataImporter
        ...
        private bool Convert()
        {
            ...
            try
            {
                ...
                using (XmlCsvReader CsvXmlConverter = new XmlCsvReader(myImportFileName, xmlDoc.NameTable))
                {
                    ...
                    CsvXmlConverter.RootName = "AccessibleAdminAreasData";
                    CsvXmlConverter.RowName = "AccessibleAdminArea";
