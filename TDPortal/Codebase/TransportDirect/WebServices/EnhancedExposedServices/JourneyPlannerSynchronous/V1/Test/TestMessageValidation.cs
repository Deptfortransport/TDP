...
//                        class.
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/WebServices/EnhancedExposedServices/JourneyPlannerSynchronous/V1/Test/TestMessageValidation.cs-arc  $
//
...
namespace TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1.Test
{
	...
	{
		private TestJourneyPlannerSyncServiceProxyReference serviceProxy;
		...
		public void Init() 
		{
			...
			serviceProxy = new TestJourneyPlannerSyncServiceProxyReference();
		...
		public void MissingTransactionId()
		{
            ...
            {
                Assert.IsTrue(soapEx.Message.IndexOf(EnhancedExposedServicesMessages.WSDLRequestValidationError) > -1);
                CompareSoapExceptionsDetails(soapEx,"TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1:transactionId");
            }
            catch (Exception ex)
            {
                Assert.Fail("Exception thrown of incorrect type. " + ex.ToString());
        ...
        public void TransactionIdTooLong()
        {
            ...
            {
                Assert.IsTrue(soapEx.Message.IndexOf(EnhancedExposedServicesMessages.WSDLRequestValidationError) > -1);
                CompareSoapExceptionsDetails(soapEx,"TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1:transactionId' element has an invalid value according to its data type");
            }
            catch (Exception ex)
            {
                Assert.Fail("Exception thrown of incorrect type. " + ex.ToString());
        ...
        public void MissingLanguage()
		{
            ...
            {
                Assert.IsTrue(soapEx.Message.IndexOf(EnhancedExposedServicesMessages.WSDLRequestValidationError) > -1);
                CompareSoapExceptionsDetails(soapEx,"TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1:language'");
            }
            catch (Exception ex)
            {
                Assert.Fail("Exception thrown of incorrect type. " + ex.ToString());
        ...
        public void MissingRequest()
        {
            ...
            {
                Assert.IsTrue(soapEx.Message.IndexOf(EnhancedExposedServicesMessages.WSDLRequestValidationError) > -1);
                CompareSoapExceptionsDetails(soapEx,"TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1:request'");
            }
            catch (Exception ex)
            {
                Assert.Fail("Exception thrown of incorrect type. " + ex.ToString());
        ...
        public void InterchangeSpeedTooLow()
        {
            ...
            CheckRequestInvalidValueForDataType(
                request,
                "TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1:InterchangeSpeed' element has an invalid value according to its data type"
                );
        }
        ...
        public void WalkingSpeedTooLow()
        {
            ...
            CheckRequestInvalidValueForDataType(
                request,
                "TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1:WalkingSpeed' element has an invalid value according to its data type"
                );
        }
        ...
        public void MaxWalkingTimeTooLow()
        {
            ...
            CheckRequestInvalidValueForDataType(
                request,
                "TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1:MaxWalkingTime' element has an invalid value according to its data type"
                );
        }
        ...
        public void SequenceTooLow()
        {
            ...
            CheckRequestInvalidValueForDataType(
                request,
                "TransportDirect.EnhancedExposedServices.JourneyPlannerSynchronous.V1:Sequence' element has an invalid value according to its data type"
                );
        }
