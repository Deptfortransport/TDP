...
// ************************************************ 
// $Log:   P:/TDPortal/archives/DotNet2.0Codebase/TransportDirect/JourneyEmissions/Test/TestJourneyEmissionsFactor.cs-arc  $
//
//   Rev 1.0   Aug 04 2009 14:36:30   mmodi
//Initial revision.
...
namespace TransportDirect.UserPortal.JourneyEmissions
{
	...
	public class TestJourneyEmissionsFactor
	{
		...
		public void TestDataReload()
		{
            ...
            journeyEmissionsData = (JourneyEmissionsFactor)TDServiceDiscovery.Current[ServiceDiscoveryKey.JourneyEmissionsFactor];
